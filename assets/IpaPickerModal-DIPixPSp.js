...
const _hoisted_2 = { class: "w-full max-w-2xl max-h-[85vh]" };
...
const _hoisted_6 = { class: "px-5 py-4 space-y-4 overflow-y-auto flex-1 min-h-0 max-h-[calc(85vh-120px)]" };
const _hoisted_7 = { class: "relative" };
const _hoisted_8 = ["placeholder"];
const _hoisted_9 = { class: "p-3 rounded-lg border border-gray-200 dark:border-dark-bg-mute bg-white dark:bg-dark-bg-mute" };
...
const _hoisted_17 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2 flex items-center" };
const _hoisted_18 = { class: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2" };
const _hoisted_19 = ["onClick", "title"];
const _hoisted_20 = { class: "font-bold text-base" };
const _hoisted_21 = { class: "text-xs text-gray-600 dark:text-gray-400" };
const _hoisted_22 = ["onClick", "title"];
const _hoisted_23 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2 flex items-center" };
const _hoisted_24 = { class: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2" };
const _hoisted_25 = ["onClick", "title"];
const _hoisted_26 = { class: "font-bold text-base" };
const _hoisted_27 = { class: "text-xs text-gray-600 dark:text-gray-400" };
const _hoisted_28 = ["onClick", "title"];
const _hoisted_29 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2 flex items-center" };
const _hoisted_30 = { class: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2" };
const _hoisted_31 = ["onClick", "title"];
const _hoisted_32 = { class: "font-bold text-base" };
const _hoisted_33 = { class: "text-xs text-gray-600 dark:text-gray-400" };
const _hoisted_34 = ["onClick", "title"];
const _hoisted_35 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2 flex items-center" };
const _hoisted_36 = { class: "flex flex-wrap gap-2" };
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_2, [
                    createBaseVNode("div", {
                      class: "bg-white dark:bg-dark-bg-soft shadow-2xl rounded-xl border border-gray-200 dark:border-dark-bg-mute overflow-hidden transform flex flex-col h-full",
                              ...
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredVowels.value, (vowel) => {
                                return openBlock(), createElementBlock("div", {
                                  ...
                                  createBaseVNode("button", {
                                    ...
                                    createBaseVNode("span", _hoisted_20, toDisplayString(vowel.symbol), 1),
                                    createBaseVNode("span", _hoisted_21, toDisplayString(vowel.letter), 1)
                                  ], 8, _hoisted_19),
                                  createBaseVNode("button", {
                                    type: "button",
                              ...
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredDiphthongs.value, (diphthong) => {
                                return openBlock(), createElementBlock("div", {
                                  ...
                                  createBaseVNode("button", {
                                    ...
                                    createBaseVNode("span", _hoisted_26, toDisplayString(diphthong.symbol), 1),
                                    createBaseVNode("span", _hoisted_27, toDisplayString(diphthong.letter), 1)
                                  ], 8, _hoisted_25),
                                  createBaseVNode("button", {
                                    type: "button",
                              ...
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredConsonants.value, (consonant) => {
                                return openBlock(), createElementBlock("div", {
                                  ...
                                  createBaseVNode("button", {
                                    ...
                                    createBaseVNode("span", _hoisted_32, toDisplayString(consonant.symbol), 1),
                                    createBaseVNode("span", _hoisted_33, toDisplayString(consonant.letter), 1)
                                  ], 8, _hoisted_31),
                                  createBaseVNode("button", {
                                    type: "button",
                          ...
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_36, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(IPA_MARKS, (mark) => {
                                ...
                                }, toDisplayString(mark === " " ? unref(t)("common.space", "Space") : mark), 9, _hoisted_37);
                              }), 64))
                            ])
                          ])
                        ])
...
//# sourceMappingURL=IpaPickerModal-DIPixPSp.js.map
