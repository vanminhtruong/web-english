...
const _hoisted_1 = {
  class: "bg-white dark:bg-[#0a0a0a] shadow border-b border-gray-200 dark:border-dark-bg-mute",
...
const _hoisted_3 = { class: "flex flex-col md:flex-row md:justify-between md:items-center gap-3 md:gap-0" };
const _hoisted_4 = { class: "text-3xl font-bold text-gray-900 dark:text-white" };
const _hoisted_5 = { class: "mt-2 text-sm text-gray-600 dark:text-white/80" };
...
//# sourceMappingURL=VocabularyHeader-CStp18uX.js.map
