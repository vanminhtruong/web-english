import { d as defineComponent, H as useI18n, A as ref, K as watch, c as createElementBlock, v as openBlock, f as createBaseVNode, b as createBlock, t as toDisplayString, u as unref, g as createTextVNode, e as createCommentVNode, a1 as Teleport } from "./vendor-DI3yOcyn.js";
import { u as useToast } from "./vendor-toast-BpLwVhAX.js";
import { c as useVocabularyStore } from "./index-BIrRStLh.js";
...
const _hoisted_7 = { class: "relative bg-white dark:bg-[#0a0a0a] rounded-lg shadow-xl w-full max-w-lg mx-auto border border-gray-200 dark:border-dark-bg-mute overflow-hidden p-6" };
const _hoisted_8 = { class: "sm:flex sm:items-start" };
...
const _hoisted_12 = { class: "text-sm text-gray-500 dark:text-gray-300" };
const _hoisted_13 = { class: "mt-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-md border border-red-200 dark:border-red-800" };
const _hoisted_14 = { class: "text-sm text-red-800 dark:text-red-300 font-medium" };
const _hoisted_15 = { class: "mt-5 sm:mt-4 sm:flex sm:flex-row-reverse" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        (openBlock(), createBlock(Teleport, { to: "body" }, [
          showDeleteAllModal.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
            ...
            createBaseVNode("div", _hoisted_7, [
              createBaseVNode("div", _hoisted_8, [
                _cache[4] || (_cache[4] = createBaseVNode("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-red-900/30 sm:mx-0 sm:h-10 sm:w-10" }, [
                  createBaseVNode("svg", {
                ...
                createBaseVNode("div", _hoisted_9, [
                  createBaseVNode("h3", _hoisted_10, toDisplayString(unref(t)("vocabulary.deleteAll.confirmTitle", "Delete All Vocabularies")), 1),
                  createBaseVNode("div", _hoisted_11, [
                    createBaseVNode("p", _hoisted_12, toDisplayString(unref(t)("vocabulary.deleteAll.confirmMessage", "Are you sure you want to delete all vocabulary words? This action cannot be undone and will permanently remove all your saved words.")), 1),
                    createBaseVNode("div", _hoisted_13, [
                      createBaseVNode("p", _hoisted_14, toDisplayString(unref(t)("vocabulary.deleteAll.warningCount", { count: _ctx.totalCount }, `You are about to delete ${_ctx.totalCount} vocabulary words.`)), 1)
                    ])
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_15, [
                ...
                createBaseVNode("button", {
                  onClick: _cache[1] || (_cache[1] = ($event) => showDeleteAllModal.value = false),
                  type: "button",
...
//# sourceMappingURL=DeleteAllVocabulariesPanel-BEnxuaH1.js.map
