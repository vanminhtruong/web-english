import { d as defineComponent, H as useI18n, A as ref, B as computed, I as onMounted, L as onUnmounted, K as watch, c as createElementBlock, v as openBlock, y as createVNode, w as withCtx, e as createCommentVNode, M as Transition, f as createBaseVNode, t as toDisplayString, u as unref, g as createTextVNode, C as withDirectives, S as vModelText, F as Fragment, j as renderList, a as normalizeStyle, i as withModifiers } from "./vendor-DMqe9Z5T.js";
import { a as _export_sfc } from "./index-SZTbn1X6.js";
...
const _hoisted_6 = { class: "flex-1 p-4 sm:p-6 md:p-6 lg:p-8 overflow-y-auto min-h-0" };
const _hoisted_7 = {
  class: "mb-4 sm:mb-6 md:mb-5 lg:mb-6 p-3 sm:p-4 md:p-4 lg:p-5 bg-gray-50 dark:bg-[#0a0a0a] rounded-lg animate-fade-in-up",
  style: { "animation-delay": "0.1s" }
};
const _hoisted_8 = { class: "text-base sm:text-lg md:text-base lg:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4 md:mb-3 lg:mb-4 flex items-center" };
const _hoisted_9 = { class: "space-y-4 sm:space-y-4 md:space-y-3 lg:space-y-4" };
const _hoisted_10 = { class: "grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-4 md:gap-3 lg:gap-4" };
const _hoisted_11 = {
...
const _hoisted_15 = { class: "block text-sm md:text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center" };
...
const _hoisted_20 = { class: "text-base sm:text-lg md:text-base lg:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4 md:mb-3 lg:mb-4 flex items-center" };
const _hoisted_21 = {
  key: 0,
...
const _hoisted_24 = { class: "flex items-center gap-4 sm:gap-4 mb-2" };
const _hoisted_25 = { class: "px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs font-medium rounded" };
const _hoisted_26 = { class: "text-sm text-gray-600 dark:text-gray-400" };
const _hoisted_27 = { class: "grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 text-sm" };
const _hoisted_28 = { class: "flex gap-3 sm:gap-4 ml-4" };
...
const _hoisted_32 = { class: "text-lg font-medium text-gray-900 dark:text-white mb-4 flex items-center" };
const _hoisted_33 = { class: "text-sm text-gray-600 dark:text-gray-400 mb-4" };
const _hoisted_34 = { class: "grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 max-h-64 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-800" };
const _hoisted_35 = { class: "flex-1" };
const _hoisted_36 = { class: "flex items-center gap-3 mb-1" };
const _hoisted_37 = { class: "px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 text-xs font-medium rounded" };
const _hoisted_38 = { class: "text-sm text-gray-600 dark:text-gray-400" };
const _hoisted_39 = { class: "grid grid-cols-1 gap-1 text-sm" };
const _hoisted_40 = { class: "ml-4" };
const _hoisted_41 = { class: "px-2 py-1 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 text-xs font-medium rounded" };
const _hoisted_42 = { class: "flex-shrink-0 flex justify-end p-4 sm:p-6 border-t border-gray-200 dark:border-dark-bg-mute bg-gradient-to-r from-gray-50 to-blue-50 dark:from-[#0a0a0a] dark:to-[#0a0a0a]" };
const _hoisted_43 = { class: "p-6" };
const _hoisted_44 = { class: "text-lg font-medium text-gray-900 dark:text-white mb-4 flex items-center" };
const _hoisted_45 = { class: "text-gray-600 dark:text-gray-300 mb-6" };
const _hoisted_46 = { class: "flex gap-3 justify-end" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const canSaveTopic = computed(() => {
      return newTopic.value.vi.trim() && newTopic.value.en.trim();
    });
                    ...
                    createBaseVNode("div", _hoisted_3, [
                      createBaseVNode("div", _hoisted_4, [
                        createBaseVNode("h2", _hoisted_5, [
                          _cache[5] || (_cache[5] = createBaseVNode("span", { class: "w-2 h-2 bg-blue-500 rounded-full animate-pulse" }, null, -1)),
                    ...
                    createBaseVNode("div", _hoisted_6, [
                      createBaseVNode("div", _hoisted_7, [
                        ...
                        createBaseVNode("div", _hoisted_9, [
                          createBaseVNode("div", _hoisted_10, [
                            createBaseVNode("div", _hoisted_11, [
                              createBaseVNode("label", _hoisted_12, [
                                _cache[8] || (_cache[8] = createBaseVNode("span", { class: "w-1 h-3 bg-purple-500 rounded mr-2" }, null, -1)),
                                createTextVNode(" " + toDisplayString(unref(t)("vocabulary.topicManager.vietnameseName", "Vietnamese Name")), 1)
                              ]),
                              withDirectives(createBaseVNode("input", {
                                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => newTopic.value.vi = $event),
                                type: "text",
                            ...
                            createBaseVNode("div", _hoisted_14, [
                              createBaseVNode("label", _hoisted_15, [
                                _cache[9] || (_cache[9] = createBaseVNode("span", { class: "w-1 h-3 bg-orange-500 rounded mr-2" }, null, -1)),
                                createTextVNode(" " + toDisplayString(unref(t)("vocabulary.topicManager.englishName", "English Name")), 1)
                              ]),
                              withDirectives(createBaseVNode("input", {
                                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => newTopic.value.en = $event),
                                type: "text",
                          ...
                          createBaseVNode("div", _hoisted_17, [
                            ...
                            }, toDisplayString(editingTopic.value ? unref(t)("common.update", "Update") : unref(t)("common.add", "Add")), 9, _hoisted_18),
                      ...
                      createBaseVNode("div", _hoisted_19, [
                        createBaseVNode("h3", _hoisted_20, [
                          _cache[10] || (_cache[10] = createBaseVNode("span", { class: "w-1 h-4 bg-indigo-500 rounded mr-2" }, null, -1)),
                          createTextVNode(" " + toDisplayString(unref(t)("vocabulary.topicManager.existingTopics", "Custom Topics")), 1)
                        ]),
                        customTopics.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_21, toDisplayString(unref(t)("vocabulary.topicManager.noCustomTopics", "No custom topics created yet")), 1)) : (openBlock(), createElementBlock("div", _hoisted_22, [
                            ...
                            return openBlock(), createElementBlock("div", {
                              ...
                              createBaseVNode("div", _hoisted_23, [
                                createBaseVNode("div", _hoisted_24, [
                                  createBaseVNode("span", _hoisted_25, toDisplayString(topic.key), 1),
                                  createBaseVNode("span", _hoisted_26, " (" + toDisplayString(getTopicUsageCount(topic.key)) + " " + toDisplayString(unref(t)("vocabulary.words", "words")) + ") ", 1)
                                ]),
                                createBaseVNode("div", _hoisted_27, [
                                  createBaseVNode("div", null, [
                                    _cache[11] || (_cache[11] = createBaseVNode("span", { class: "font-medium" }, "VI:", -1)),
                                    createTextVNode(" " + toDisplayString(topic.vi), 1)
                                  ]),
                                  createBaseVNode("div", null, [
                                    _cache[12] || (_cache[12] = createBaseVNode("span", { class: "font-medium" }, "EN:", -1)),
                      ...
                      createBaseVNode("div", _hoisted_31, [
                        createBaseVNode("h3", _hoisted_32, [
                          _cache[15] || (_cache[15] = createBaseVNode("span", { class: "w-1 h-4 bg-teal-500 rounded mr-2" }, null, -1)),
                          createTextVNode(" " + toDisplayString(unref(t)("vocabulary.topicManager.builtInTopics", "Built-in Topics")), 1)
                        ]),
                        createBaseVNode("p", _hoisted_33, toDisplayString(unref(t)("vocabulary.topicManager.builtInTopicsDescription", "These are system-provided topics that cannot be modified")), 1),
                            ...
                            return openBlock(), createElementBlock("div", {
                              ...
                              createBaseVNode("div", _hoisted_35, [
                                createBaseVNode("div", _hoisted_36, [
                                  createBaseVNode("span", _hoisted_37, toDisplayString(topic.key), 1),
                                  createBaseVNode("span", _hoisted_38, " (" + toDisplayString(getTopicUsageCount(topic.key)) + " " + toDisplayString(unref(t)("vocabulary.words", "words")) + ") ", 1)
                                ]),
                                createBaseVNode("div", _hoisted_39, [
                                  createBaseVNode("div", null, [
                                    _cache[16] || (_cache[16] = createBaseVNode("span", { class: "font-medium" }, "VI:", -1)),
                                    createTextVNode(" " + toDisplayString(topic.vi), 1)
                                  ]),
                                  createBaseVNode("div", null, [
                                    _cache[17] || (_cache[17] = createBaseVNode("span", { class: "font-medium" }, "EN:", -1)),
                                    createTextVNode(" " + toDisplayString(topic.en), 1)
                                  ])
                                ])
                              ]),
                              createBaseVNode("div", _hoisted_40, [
                                createBaseVNode("span", _hoisted_41, toDisplayString(unref(t)("vocabulary.topicManager.builtIn", "Built-in")), 1)
                              ])
                            ], 4);
                          }), 128))
                        ])
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            showDeleteModal.value ? (openBlock(), createElementBlock("div", {
              ...
              onClick: _cache[4] || (_cache[4] = withModifiers(($event) => topicToDelete.value = null, ["self"]))
            }, [
              createVNode(Transition, {
                "enter-active-class": "transition-all duration-300 ease-out",
                  ...
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("div", _hoisted_43, [
                      createBaseVNode("h3", _hoisted_44, [
                        _cache[18] || (_cache[18] = createBaseVNode("span", { class: "w-2 h-2 bg-red-500 rounded-full mr-2 animate-pulse" }, null, -1)),
                        createTextVNode(" " + toDisplayString(unref(t)("vocabulary.topicManager.confirmDeleteTitle", "Confirm Delete")), 1)
                      ]),
                      createBaseVNode("p", _hoisted_45, toDisplayString(unref(t)("vocabulary.topicManager.confirmDeleteMessage", { topic: topicToDelete.value?.vi || topicToDelete.value?.en || "this topic" }, `Are you sure you want to delete "${topicToDelete.value?.vi || topicToDelete.value?.en || "this topic"}"?`)), 1),
                      createBaseVNode("div", _hoisted_46, [
                        createBaseVNode("button", {
                          onClick: _cache[2] || (_cache[2] = ($event) => topicToDelete.value = null),
...
const TopicManager = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d2b08ed0"]]);
export {
  TopicManager as default
};
//# sourceMappingURL=TopicManager-zjbfoQFh.js.map
