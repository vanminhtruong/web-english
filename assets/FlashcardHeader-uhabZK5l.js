import { d as defineComponent, B as computed, H as useI18n, A as ref, I as onMounted, a0 as onBeforeUnmount, c as createElementBlock, v as openBlock, f as createBaseVNode, t as toDisplayString, u as unref, n as normalizeClass, y as createVNode, w as withCtx, e as createCommentVNode, i as withModifiers, M as Transition } from "./vendor-DMqe9Z5T.js";
...
const _hoisted_30 = { class: "px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-2" };
const _hoisted_31 = ["disabled", "aria-disabled", "title"];
const _hoisted_32 = ["title", "aria-label"];
const _hoisted_33 = { class: "px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-2" };
const _hoisted_34 = ["disabled", "aria-disabled", "title"];
const _hoisted_35 = ["title", "aria-label"];
const _hoisted_36 = { class: "px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-2" };
const _hoisted_37 = ["title"];
const _hoisted_38 = ["title", "aria-label"];
const _hoisted_39 = ["disabled", "title"];
const _hoisted_40 = { class: "hidden sm:flex items-center justify-between" };
const _hoisted_41 = { class: "flex items-center" };
const _hoisted_42 = { class: "text-2xl md:text-3xl font-bold text-gray-900 dark:text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400" };
const _hoisted_43 = { class: "mt-1 md:mt-2 text-sm md:text-base text-gray-600 dark:text-white/70" };
const _hoisted_44 = { class: "flex items-center space-x-3 md:space-x-4" };
const _hoisted_45 = ["title"];
const _hoisted_46 = { class: "flex items-center space-x-2 md:space-x-3" };
const _hoisted_47 = { class: "text-sm md:text-base text-gray-600 dark:text-white/70" };
const _hoisted_48 = ["disabled", "title"];
const _hoisted_49 = { class: "text-right" };
const _hoisted_50 = { class: "text-sm md:text-base text-gray-500 dark:text-white/60" };
const _hoisted_51 = { class: "text-lg md:text-xl font-semibold text-gray-900 dark:text-white" };
const _hoisted_52 = { class: "flex items-center space-x-2 md:space-x-3" };
const _hoisted_53 = { class: "relative" };
const _hoisted_54 = ["disabled", "aria-disabled", "title", "aria-label"];
const _hoisted_55 = { class: "truncate" };
const _hoisted_56 = {
  key: 0,
...
const _hoisted_57 = { class: "py-1 text-sm text-gray-900 dark:text-white" };
...
const _hoisted_61 = ["title", "aria-label"];
const _hoisted_62 = { class: "px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-3" };
const _hoisted_63 = ["disabled", "aria-disabled", "title"];
const _hoisted_64 = ["title", "aria-label"];
const _hoisted_65 = { class: "px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-3" };
...
const _hoisted_77 = ["disabled", "aria-disabled", "title"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["go-back", "show-history", "change-practice-mode", "show-settings", "toggle-shuffle", "update:image-quiz-enabled", "update:listening-quiz-enabled", "update:typing-quiz-enabled", "update:bubble-shooter-vietnamese-mode", "update:snake-double-bait-enabled", "update:pictionary-definition-mode", "update:use-flip-tile-hints"],
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_10, [
              ...
              createBaseVNode("div", _hoisted_14, [
                      ...
                      mobileDropdownOpen.value && !_ctx.practiceStarted ? (openBlock(), createElementBlock("div", _hoisted_18, [
                        createBaseVNode("ul", _hoisted_19, [
                          ...
                          createBaseVNode("li", _hoisted_30, [
                            ...
                            }, toDisplayString(unref(t)("flashcard.modes.flipTile", "Flip Tile")), 11, _hoisted_31),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-4 w-8 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                              ...
                              onClick: _cache[13] || (_cache[13] = withModifiers(($event) => flipTileModeAvailable.value && toggleFlipTileHintsFromDropdown(), ["stop"])),
                          ...
                          createBaseVNode("li", _hoisted_33, [
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[14] || (_cache[14] = ($event) => selectMode("bubble-shooter")),
                            ...
                            }, toDisplayString(unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter")), 11, _hoisted_34),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-4 w-8 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                              ...
                              onClick: _cache[15] || (_cache[15] = withModifiers(($event) => bubbleShooterModeAvailable.value && toggleBubbleShooterVietnameseMode(), ["stop"])),
                          ...
                          createBaseVNode("li", _hoisted_36, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[16] || (_cache[16] = ($event) => selectMode("snake-game")),
                              title: unref(t)("flashcard.modes.snakeGame", "Snake Hunt")
                            }, toDisplayString(unref(t)("flashcard.modes.snakeGame", "Snake Hunt")), 9, _hoisted_37),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-4 w-8 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                              ...
                              onClick: _cache[17] || (_cache[17] = withModifiers(($event) => toggleSnakeDoubleBaitFromDropdown(), ["stop"])),
                          ...
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[18] || (_cache[18] = ($event) => selectMode("pronunciation"))
                ...
                createBaseVNode("button", {
                  onClick: _cache[19] || (_cache[19] = ($event) => _ctx.$emit("toggle-shuffle")),
                  disabled: _ctx.practiceStarted,
          ...
          createBaseVNode("div", _hoisted_40, [
            createBaseVNode("div", _hoisted_41, [
              createBaseVNode("button", {
                onClick: _cache[20] || (_cache[20] = ($event) => _ctx.$emit("go-back")),
              ...
              createBaseVNode("div", null, [
                createBaseVNode("h1", _hoisted_42, toDisplayString(unref(t)("flashcard.modes.flashcard", "Flashcard")), 1),
                createBaseVNode("p", _hoisted_43, toDisplayString(unref(t)("flashcard.header.description", "Practice vocabulary with flashcards")), 1)
              ])
            ]),
            createBaseVNode("div", _hoisted_44, [
              createBaseVNode("button", {
                onClick: _cache[21] || (_cache[21] = ($event) => _ctx.$emit("show-history")),
              ...
              createBaseVNode("div", _hoisted_46, [
                createBaseVNode("span", _hoisted_47, toDisplayString(unref(t)("flashcard.settings.shuffle", "Shuffle")), 1),
                createBaseVNode("button", {
                  onClick: _cache[22] || (_cache[22] = ($event) => _ctx.$emit("toggle-shuffle")),
                  disabled: _ctx.practiceStarted,
                  class: normalizeClass([
              ...
              createBaseVNode("div", _hoisted_49, [
                createBaseVNode("p", _hoisted_50, toDisplayString(unref(t)("flashcard.header.progress", "Progress")), 1),
                createBaseVNode("p", _hoisted_51, toDisplayString(_ctx.currentIndex + 1) + " / " + toDisplayString(_ctx.totalCards), 1)
              ]),
              createBaseVNode("div", _hoisted_52, [
                createBaseVNode("div", _hoisted_53, [
                  createBaseVNode("button", {
                    ...
                    createBaseVNode("span", _hoisted_55, toDisplayString(_ctx.practiceMode === "flashcard" ? unref(t)("flashcard.modes.flashcard", "Flashcard") : _ctx.practiceMode === "quiz" ? unref(t)("flashcard.modes.quiz", "Quiz") : _ctx.practiceMode === "typing" ? unref(t)("flashcard.modes.typing", "Typing") : _ctx.practiceMode === "listening" ? unref(t)("flashcard.modes.listening", "Listening") : _ctx.practiceMode === "image" ? unref(t)("flashcard.modes.image", "Image") : _ctx.practiceMode === "pictionary" ? unref(t)("flashcard.modes.pictionary", "Pictionary") : _ctx.practiceMode === "flip-tile" ? unref(t)("flashcard.modes.flipTile", "Flip Tile") : _ctx.practiceMode === "bubble-shooter" ? unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter") : _ctx.practiceMode === "snake-game" ? unref(t)("flashcard.modes.snakeGame", "Snake Hunt") : unref(t)("flashcard.modes.pronunciation", "Pronunciation")), 1),
                    _cache[46] || (_cache[46] = createBaseVNode("svg", {
                  ...
                  createVNode(Transition, {
                    ...
                    default: withCtx(() => [
                      desktopDropdownOpen.value && !_ctx.practiceStarted ? (openBlock(), createElementBlock("div", _hoisted_56, [
                        createBaseVNode("ul", _hoisted_57, [
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[23] || (_cache[23] = ($event) => selectMode("flashcard"))
                            }, toDisplayString(unref(t)("flashcard.modes.flashcard", "Flashcard")), 1)
                          ]),
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[24] || (_cache[24] = ($event) => selectMode("quiz"))
                            }, toDisplayString(unref(t)("flashcard.modes.quiz", "Quiz")), 1)
                          ]),
                          createBaseVNode("li", _hoisted_58, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[25] || (_cache[25] = ($event) => selectMode("typing"))
                            }, toDisplayString(unref(t)("flashcard.modes.typing", "Typing")), 1),
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[26] || (_cache[26] = withModifiers(($event) => toggleTypingQuizFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.typing.quizToggle", "Multiple Choice"),
                              "aria-label": unref(t)("flashcard.typing.quizToggle", "Multiple Choice")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_60, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[27] || (_cache[27] = ($event) => selectMode("listening"))
                            }, toDisplayString(unref(t)("flashcard.modes.listening", "Listening")), 1),
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[28] || (_cache[28] = withModifiers(($event) => toggleListeningQuizFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.listening.quizToggle", "Multiple Choice"),
                              "aria-label": unref(t)("flashcard.listening.quizToggle", "Multiple Choice")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_62, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !imageModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[29] || (_cache[29] = ($event) => selectMode("image")),
                              disabled: !imageModeAvailable.value,
                              "aria-disabled": !imageModeAvailable.value ? "true" : "false",
                              title: !imageModeAvailable.value ? unref(t)("flashcard.image.unavailable", "Image mode is unavailable for the selected date") : unref(t)("flashcard.modes.image", "Image")
                            }, toDisplayString(unref(t)("flashcard.modes.image", "Image")), 11, _hoisted_63),
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[30] || (_cache[30] = withModifiers(($event) => imageModeAvailable.value && toggleImageQuizFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.image.quizToggle", "Multiple Choice"),
                              "aria-label": unref(t)("flashcard.image.quizToggle", "Multiple Choice")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_65, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !pictionaryModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[31] || (_cache[31] = ($event) => selectMode("pictionary")),
                              disabled: !pictionaryModeAvailable.value,
                              "aria-disabled": !pictionaryModeAvailable.value ? "true" : "false",
                              title: !pictionaryModeAvailable.value ? unref(t)("flashcard.pictionary.unavailable", "Pictionary mode is unavailable for the selected date") : unref(t)("flashcard.modes.pictionary", "Pictionary")
                            }, toDisplayString(unref(t)("flashcard.modes.pictionary", "Pictionary")), 11, _hoisted_66),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                pictionaryModeAvailable.value ? pictionaryDefinitionMode.value ? "bg-teal-600" : "bg-gray-200 dark:bg-[#0a0a0a]" : "opacity-50 cursor-not-allowed pointer-events-none bg-gray-200 dark:bg-[#0a0a0a]"
                              ]]),
                              onClick: _cache[32] || (_cache[32] = withModifiers(($event) => pictionaryModeAvailable.value && togglePictionaryDefinitionModeFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.pictionary.definitionToggle", "Definition Mode"),
                              "aria-label": unref(t)("flashcard.pictionary.definitionToggle", "Definition Mode")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_68, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !flipTileModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[33] || (_cache[33] = ($event) => selectMode("flip-tile")),
                              disabled: !flipTileModeAvailable.value,
                              "aria-disabled": !flipTileModeAvailable.value ? "true" : "false",
                              title: !flipTileModeAvailable.value ? unref(t)("flashcard.flipTile.unavailable", "Flip Tile mode is unavailable for the selected date") : unref(t)("flashcard.modes.flipTile", "Flip Tile")
                            }, toDisplayString(unref(t)("flashcard.modes.flipTile", "Flip Tile")), 11, _hoisted_69),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                flipTileModeAvailable.value ? useFlipTileHints.value ? "bg-teal-600" : "bg-gray-200 dark:bg-[#0a0a0a]" : "opacity-50 cursor-not-allowed pointer-events-none bg-gray-200 dark:bg-[#0a0a0a]"
                              ]]),
                              onClick: _cache[34] || (_cache[34] = withModifiers(($event) => flipTileModeAvailable.value && toggleFlipTileHintsFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.flipTile.hintsToggle", "Use Definition Hints"),
                              "aria-label": unref(t)("flashcard.flipTile.hintsToggle", "Use Definition Hints")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_71, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !bubbleShooterModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[35] || (_cache[35] = ($event) => selectMode("bubble-shooter")),
                              disabled: !bubbleShooterModeAvailable.value,
                              "aria-disabled": !bubbleShooterModeAvailable.value ? "true" : "false",
                              title: !bubbleShooterModeAvailable.value ? unref(t)("flashcard.bubbleShooter.unavailable", "Bubble Shooter mode is disabled for dates with more than 8 vocabulary words") : unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter")
                            }, toDisplayString(unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter")), 11, _hoisted_72),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                bubbleShooterModeAvailable.value ? bubbleShooterVietnameseMode.value ? "bg-orange-600" : "bg-gray-200 dark:bg-[#0a0a0a]" : "opacity-50 cursor-not-allowed pointer-events-none bg-gray-200 dark:bg-[#0a0a0a]"
                              ]]),
                              onClick: _cache[36] || (_cache[36] = withModifiers(($event) => bubbleShooterModeAvailable.value && toggleBubbleShooterVietnameseMode(), ["stop"])),
                              title: unref(t)("flashcard.bubbleShooter.vietnameseModeToggle", "Vietnamese First Letter Mode"),
                              "aria-label": unref(t)("flashcard.bubbleShooter.vietnameseModeToggle", "Vietnamese First Letter Mode")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_74, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[37] || (_cache[37] = ($event) => selectMode("snake-game")),
                              title: unref(t)("flashcard.modes.snakeGame", "Snake Hunt")
                            }, toDisplayString(unref(t)("flashcard.modes.snakeGame", "Snake Hunt")), 9, _hoisted_75),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                snakeDoubleBaitEnabled.value ? "bg-emerald-600" : "bg-gray-200 dark:bg-[#0a0a0a]",
                                _ctx.practiceStarted ? "opacity-50 cursor-not-allowed pointer-events-none" : ""
                              ]]),
                              onClick: _cache[38] || (_cache[38] = withModifiers(($event) => toggleSnakeDoubleBaitFromDropdown(), ["stop"])),
                              title: _ctx.practiceStarted ? unref(t)("flashcard.settings.disabledDuringPractice", "Settings are disabled during practice") : unref(t)("flashcard.snake.doubleBaitToggle", "Double Bait Mode"),
                              "aria-label": unref(t)("flashcard.snake.doubleBaitToggle", "Double Bait Mode")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[39] || (_cache[39] = ($event) => selectMode("pronunciation"))
                            }, toDisplayString(unref(t)("flashcard.modes.pronunciation", "Pronunciation")), 1)
                          ])
                        ])
                      ])) : createCommentVNode("", true)
...
//# sourceMappingURL=FlashcardHeader-uhabZK5l.js.map
