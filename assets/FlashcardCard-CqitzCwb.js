...
import { g as getTopicName, _ as __vitePreload, e as useVoiceStore, a as _export_sfc } from "./index-SZTbn1X6.js";
...
const _hoisted_17 = { class: "flex justify-center flex-wrap gap-2 sm:gap-3 md:gap-4 xl:gap-3 2xl:gap-3 mb-4 sm:mb-5 md:mb-6 px-2 sm:px-4 md:px-6 xl:px-8 2xl:px-12 max-w-full" };
...
const FlashcardCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a3f18898"]]);
export {
  FlashcardCard as default
};
//# sourceMappingURL=FlashcardCard-CqitzCwb.js.map
