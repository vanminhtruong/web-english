const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ImageUpload-DKIRvyoI.js","assets/vendor-DoTKyHPB.js","assets/TopicManager-sSfR2h4N.js","assets/index-BxypgJoH.js","assets/vendor-toast-D1B2ty4j.js","assets/vendor-toast-jG2HNJHr.css","assets/index-Doxc-T0u.css","assets/TopicManager-SGNt9NVM.css","assets/IpaPickerModal-B5ByNvLh.js","assets/KoreanInputHelper-c5FnVm6c.js","assets/KoreanInputHelper-DXOcyaJN.css","assets/KoreanPronunciationHelper-DxFuTEak.js","assets/KoreanPronunciationHelper-pIazWW2U.css"])))=>i.map(i=>d[i]);
import { c as useVocabularyStore, g as getTopicName, _ as __vitePreload, a as _export_sfc } from "./index-BxypgJoH.js";
import { d as defineComponent, H as useI18n, A as ref, B as computed, a1 as reactive, I as onMounted, q as nextTick, L as onUnmounted, K as watch, c as createElementBlock, v as openBlock, y as createVNode, b as createBlock, e as createCommentVNode, w as withCtx, M as Transition, f as createBaseVNode, i as withModifiers, t as toDisplayString, u as unref, g as createTextVNode, C as withDirectives, n as normalizeClass, S as vModelText, O as vModelSelect, a0 as Teleport, a as normalizeStyle, Z as withKeys, F as Fragment, j as renderList, D as defineAsyncComponent, N as vModelCheckbox } from "./vendor-DoTKyHPB.js";
...
const _hoisted_20 = { value: "noun" };
const _hoisted_21 = { value: "verb" };
const _hoisted_22 = { value: "adjective" };
const _hoisted_23 = { value: "adverb" };
const _hoisted_24 = { value: "preposition" };
const _hoisted_25 = { value: "conjunction" };
const _hoisted_26 = { value: "interjection" };
const _hoisted_27 = {
  class: "animate-fade-in-up",
...
const _hoisted_32 = ["placeholder", "value"];
const _hoisted_33 = { class: "absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none" };
const _hoisted_34 = ["placeholder"];
const _hoisted_35 = { class: "max-h-40 overflow-y-auto" };
const _hoisted_36 = {
  key: 0,
...
const _hoisted_41 = { value: "beginner" };
const _hoisted_42 = { value: "intermediate" };
const _hoisted_43 = { value: "advanced" };
const _hoisted_44 = {
  class: "md:col-span-2 animate-fade-in-up",
...
const _hoisted_61 = { class: "flex items-center p-3 bg-gray-50 dark:bg-[#0a0a0a] rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300" };
const _hoisted_62 = {
  for: "favorite",
...
const _hoisted_63 = { class: "px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-[#0a0a0a] dark:to-[#0a0a0a]" };
const _hoisted_64 = { class: "flex justify-end space-x-3" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const TopicManager = defineAsyncComponent(() => __vitePreload(() => import("./TopicManager-sSfR2h4N.js"), true ? __vite__mapDeps([2,1,3,4,5,6,7]) : void 0));
    ...
    const KoreanInputHelper = defineAsyncComponent(() => __vitePreload(() => import("./KoreanInputHelper-c5FnVm6c.js"), true ? __vite__mapDeps([9,1,3,4,5,6,10]) : void 0));
    const KoreanPronunciationHelper = defineAsyncComponent(() => __vitePreload(() => import("./KoreanPronunciationHelper-DxFuTEak.js"), true ? __vite__mapDeps([11,1,3,4,5,6,12]) : void 0));
    const props = __props;
    const emit = __emit;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
                          ...
                          createBaseVNode("div", _hoisted_6, [
                            ...
                            createBaseVNode("div", _hoisted_17, [
                              ...
                              withDirectives(createBaseVNode("select", {
                                ...
                                createBaseVNode("option", _hoisted_19, toDisplayString(unref(t)("vocabulary.selectWordType", "Select word type")), 1),
                                createBaseVNode("option", _hoisted_20, toDisplayString(unref(t)("vocabulary.wordTypes.noun", "Noun")), 1),
                                createBaseVNode("option", _hoisted_21, toDisplayString(unref(t)("vocabulary.wordTypes.verb", "Verb")), 1),
                                createBaseVNode("option", _hoisted_22, toDisplayString(unref(t)("vocabulary.wordTypes.adjective", "Adjective")), 1),
                                createBaseVNode("option", _hoisted_23, toDisplayString(unref(t)("vocabulary.wordTypes.adverb", "Adverb")), 1),
                                createBaseVNode("option", _hoisted_24, toDisplayString(unref(t)("vocabulary.wordTypes.preposition", "Preposition")), 1),
                                createBaseVNode("option", _hoisted_25, toDisplayString(unref(t)("vocabulary.wordTypes.conjunction", "Conjunction")), 1),
                                createBaseVNode("option", _hoisted_26, toDisplayString(unref(t)("vocabulary.wordTypes.interjection", "Interjection")), 1)
                              ], 544), [
                            ...
                            createBaseVNode("div", _hoisted_27, [
                              ...
                              createBaseVNode("div", _hoisted_29, [
                                createBaseVNode("button", {
                                  type: "button",
                                  onClick: _cache[4] || (_cache[4] = ($event) => showTopicManager.value = true),
                                      ...
                                      default: withCtx(() => [
                                        showCategoryDropdown.value ? (openBlock(), createElementBlock("div", {
                                          ...
                                          createBaseVNode("div", _hoisted_35, [
                                            filteredCategoryKeys.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_36, toDisplayString(unref(t)("vocabulary.noCategories", "No categories found")), 1)) : createCommentVNode("", true),
                                            (openBlock(true), createElementBlock(Fragment, null, renderList(filteredCategoryKeys.value, (key) => {
                                              ...
                                              }, toDisplayString(getTopicDisplayName(key)), 11, _hoisted_37);
                                            }), 128))
                                          ])
                            ...
                            createBaseVNode("div", _hoisted_38, [
                              ...
                              withDirectives(createBaseVNode("select", {
                                ...
                                createBaseVNode("option", _hoisted_40, toDisplayString(unref(t)("vocabulary.selectLevel", "Select level")), 1),
                                createBaseVNode("option", _hoisted_41, toDisplayString(unref(t)("vocabulary.levels.beginner", "Beginner")), 1),
                                createBaseVNode("option", _hoisted_42, toDisplayString(unref(t)("vocabulary.levels.intermediate", "Intermediate")), 1),
                                createBaseVNode("option", _hoisted_43, toDisplayString(unref(t)("vocabulary.levels.advanced", "Advanced")), 1)
                              ], 544), [
                            ...
                            createBaseVNode("div", _hoisted_60, [
                              createBaseVNode("div", _hoisted_61, [
                                ...
                                createBaseVNode("label", _hoisted_62, toDisplayString(unref(t)("vocabulary.isFavorite", "Mark as favorite")), 1)
                              ])
                            ])
                          ])
                        ], 32)
                      ...
                      createBaseVNode("div", _hoisted_63, [
                        createBaseVNode("div", _hoisted_64, [
                          ...
                          createBaseVNode("button", {
                            ...
                            isSubmitting.value ? (openBlock(), createElementBlock("svg", _hoisted_66, _cache[41] || (_cache[41] = [
        ...
        showKoreanInputHelper.value ? (openBlock(), createBlock(unref(KoreanInputHelper), {
          key: 1,
...
const VocabularyFormDialog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6deb5ddf"]]);
export {
  VocabularyFormDialog as default
};
//# sourceMappingURL=VocabularyFormDialog-CkAcHPVo.js.map
