const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ThemeToggle-52ElyULs.js","assets/index-CCffuzjZ.js","assets/vendor-kzGOnAa-.js","assets/vendor-toast-DUxYViPJ.js","assets/vendor-toast-jG2HNJHr.css","assets/index-BbxNybA7.css","assets/ThemeToggle-DSsMUYxu.css","assets/LanguageSwitcher-BUxbDB8p.js"])))=>i.map(i=>d[i]);
import { l as loadComponentSafely, _ as __vitePreload, a as _export_sfc } from "./index-CCffuzjZ.js";
import { d as defineComponent, H as useI18n, S as useRoute, G as useRouter, A as ref, I as onMounted, L as onUnmounted, K as watch, B as computed, c as createElementBlock, v as openBlock, f as createBaseVNode, C as withDirectives, u as unref, Z as withKeys, i as withModifiers, F as Fragment, j as renderList, a as normalizeStyle, n as normalizeClass, t as toDisplayString, y as createVNode, w as withCtx, g as createTextVNode, _ as RouterLink, D as defineAsyncComponent, E as vShow } from "./vendor-kzGOnAa-.js";
...
const _hoisted_28 = { class: "absolute bottom-0 left-0 right-0 h-1 bg-gray-200/20 dark:bg-white/10" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ThemeToggle = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./ThemeToggle-52ElyULs.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0))
    );
    const LanguageSwitcher = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./LanguageSwitcher-BUxbDB8p.js"), true ? __vite__mapDeps([7,1,2,3,4,5]) : void 0))
    );
    const { t } = useI18n();
...
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6bee85cc"]]);
export {
  AppHeader as default
};
//# sourceMappingURL=AppHeader-4BnfzKjE.js.map
