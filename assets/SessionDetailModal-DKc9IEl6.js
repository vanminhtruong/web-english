...
const _hoisted_40 = { class: "bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800/50 p-3 animate-fade-in-up" };
...
const _hoisted_47 = { class: "text-xs text-gray-500 dark:text-white/70 mt-1" };
const _hoisted_48 = { class: "grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 text-xs" };
const _hoisted_49 = { class: "bg-white dark:bg-[#0a0a0a] rounded-md p-2 border border-gray-200 dark:border-dark-bg-mute" };
const _hoisted_50 = { class: "font-semibold text-gray-900 dark:text-white animate-counter" };
const _hoisted_51 = { class: "bg-white dark:bg-[#0a0a0a] rounded-md p-2 border border-gray-200 dark:border-dark-bg-mute" };
const _hoisted_52 = { class: "font-semibold text-emerald-600 dark:text-emerald-400 animate-counter" };
const _hoisted_53 = { class: "bg-white dark:bg-[#0a0a0a] rounded-md p-2 border border-gray-200 dark:border-dark-bg-mute" };
const _hoisted_54 = { class: "font-semibold text-blue-600 dark:text-blue-400 animate-counter" };
const _hoisted_55 = { class: "bg-white dark:bg-[#0a0a0a] rounded-md p-2 border border-gray-200 dark:border-dark-bg-mute" };
const _hoisted_56 = { class: "font-semibold text-red-600 dark:text-red-400 animate-counter" };
const _hoisted_57 = { class: "mt-3" };
const _hoisted_58 = { class: "relative bg-gray-100 dark:bg-[#0f0f0f] rounded-md p-2 overflow-hidden" };
const _hoisted_59 = {
  class: "grid grid-cols-15 gap-px",
  style: { "grid-template-columns": "repeat(15, minmax(0, 1fr))" }
};
const _hoisted_60 = { class: "absolute inset-0 pointer-events-none" };
const _hoisted_61 = { class: "w-full h-full flex items-center justify-center" };
const _hoisted_62 = { class: "absolute inset-0 pointer-events-none" };
const _hoisted_63 = { class: "absolute inset-0 pointer-events-none" };
const _hoisted_64 = { class: "mt-2 text-xs text-gray-500 dark:text-white/70 flex items-center gap-4" };
...
const _hoisted_70 = { class: "text-xs text-gray-500 dark:text-white/70" };
const _hoisted_71 = {
  key: 0,
  class: "fixed inset-0 z-[70] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4"
};
const _hoisted_72 = { class: "bg-white dark:bg-[#0a0a0a] shadow-2xl rounded-xl border border-gray-200 dark:border-dark-bg-mute flex flex-col max-h-[86vh]" };
const _hoisted_73 = { class: "px-6 py-4 border-b border-gray-200 dark:border-dark-bg-mute flex-shrink-0 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-[#0a0a0a] dark:to-[#0a0a0a] rounded-t-xl" };
const _hoisted_74 = { class: "flex items-center justify-between" };
const _hoisted_75 = { class: "text-lg md:text-xl font-semibold text-gray-900 dark:text-white flex items-center gap-2" };
const _hoisted_76 = ["aria-label"];
const _hoisted_77 = { class: "p-4 md:p-6 overflow-y-auto min-h-0" };
const _hoisted_78 = { class: "flex flex-col md:flex-row gap-6 items-start" };
const _hoisted_79 = {
  key: 0,
  class: "flex-shrink-0"
};
const _hoisted_80 = ["src", "alt"];
const _hoisted_81 = { class: "flex-1" };
const _hoisted_82 = { class: "flex flex-wrap gap-2 items-center" };
const _hoisted_83 = { class: "uppercase tracking-wider" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getSnakeGridCellClass = (index, snakeData) => {
      const gridWidth = 15;
      ...
      if (x === scaledFoodX && y === scaledFoodY) {
        return snakeData.wasCorrect ? "bg-emerald-400 dark:bg-emerald-500 animate-bounce shadow-lg" : "bg-red-400 dark:bg-red-500 animate-ping shadow-lg";
      }
      return "bg-gray-200 dark:bg-[#0f0f0f] hover:bg-gray-300 dark:hover:bg-[#1a1a1a] transition-colors";
    };
    const getSnakeHeadPositionStyle = (headPosition) => {
      const cellSize = 8;
      const gap = 1;
    ...
    const getSnakeSegmentPositionStyle = (segment) => {
      const cellSize = 8;
      const gap = 1;
    ...
    const getDirectionIndicatorStyle = (direction) => {
          ...
          default: withCtx(() => [
            _ctx.show ? (openBlock(), createElementBlock("div", _hoisted_1, [
                              ...
                              return openBlock(), createElementBlock("div", {
                                ...
                                createBaseVNode("div", _hoisted_25, [
                                  createBaseVNode("div", _hoisted_26, [
                                    ...
                                    e.mode === "snake-game" && e.extra?.snakeGame ? (openBlock(), createElementBlock("div", _hoisted_39, [
                                        ...
                                        createBaseVNode("div", _hoisted_41, [
                                          createBaseVNode("div", _hoisted_42, [
                                            createBaseVNode("div", {
                                              ...
                                              e.extra.snakeGame.wasCorrect ? (openBlock(), createElementBlock("svg", _hoisted_43, _cache[5] || (_cache[5] = [
                                              ...
                                              ]))) : (openBlock(), createElementBlock("svg", _hoisted_44, _cache[6] || (_cache[6] = [
                                          ...
                                          createBaseVNode("div", _hoisted_45, [
                                            ...
                                            createBaseVNode("div", _hoisted_47, " Position: (" + toDisplayString(e.extra.snakeGame.position.x) + ", " + toDisplayString(e.extra.snakeGame.position.y) + ") ", 1)
                                          ])
                                        ]),
                                        createBaseVNode("div", _hoisted_48, [
                                          createBaseVNode("div", _hoisted_49, [
                                            _cache[7] || (_cache[7] = createBaseVNode("div", { class: "text-gray-500 dark:text-white/70" }, "Snake Length", -1)),
                                            createBaseVNode("div", _hoisted_50, toDisplayString(e.extra.snakeGame.snakeLength), 1)
                                          ]),
                                          createBaseVNode("div", _hoisted_51, [
                                            _cache[8] || (_cache[8] = createBaseVNode("div", { class: "text-gray-500 dark:text-white/70" }, "Game Score", -1)),
                                            createBaseVNode("div", _hoisted_52, toDisplayString(e.extra.snakeGame.gameScore), 1)
                                          ]),
                                          createBaseVNode("div", _hoisted_53, [
                                            _cache[9] || (_cache[9] = createBaseVNode("div", { class: "text-gray-500 dark:text-white/70" }, "Words Done", -1)),
                                            createBaseVNode("div", _hoisted_54, toDisplayString(e.extra.snakeGame.wordsCompleted), 1)
                                          ]),
                                          createBaseVNode("div", _hoisted_55, [
                                            _cache[10] || (_cache[10] = createBaseVNode("div", { class: "text-gray-500 dark:text-white/70" }, "Wrong Bites", -1)),
                                            createBaseVNode("div", _hoisted_56, toDisplayString(e.extra.snakeGame.wrongEatenCount), 1)
                                          ])
                                        ]),
                                        createBaseVNode("div", _hoisted_57, [
                                          ...
                                          createBaseVNode("div", _hoisted_58, [
                                            createBaseVNode("div", _hoisted_59, [
                                              (openBlock(), createElementBlock(Fragment, null, renderList(225, (i) => {
                                                return createBaseVNode("div", {
                                                  key: i,
                                                  class: normalizeClass(["w-2 h-2 transition-all duration-500", getSnakeGridCellClass(i - 1, e.extra.snakeGame)])
                                                }, null, 2);
                                              }), 64))
                                            ]),
                                            createBaseVNode("div", _hoisted_60, [
                                              e.extra.snakeGame.snakeBody && e.extra.snakeGame.snakeBody.length > 0 ? (openBlock(), createElementBlock("div", {
                                                key: 0,
                                                class: "w-3 h-3 rounded-full animate-pulse bg-green-500 border border-green-300",
                                                style: normalizeStyle(getSnakeHeadPositionStyle(e.extra.snakeGame.snakeBody[0]))
                                              }, [
                                                createBaseVNode("div", _hoisted_61, [
                                                  createBaseVNode("div", {
                                                    class: "w-1 h-1 bg-white rounded-full animate-bounce",
                                                    style: normalizeStyle(getDirectionIndicatorStyle(e.extra.snakeGame.direction))
                                                  }, null, 4)
                                                ])
                                            ...
                                            createBaseVNode("div", _hoisted_62, [
                                              createBaseVNode("div", {
                                                class: normalizeClass(["w-3 h-3 rounded-full animate-ping", e.extra.snakeGame.wasCorrect ? "bg-emerald-400" : "bg-red-400"]),
                                                style: normalizeStyle(getFoodPositionStyle(e.extra.snakeGame.position))
                                              }, null, 6)
                                            ]),
                                            createBaseVNode("div", _hoisted_63, [
                                              (openBlock(true), createElementBlock(Fragment, null, renderList((e.extra.snakeGame.snakeBody || []).slice(1), (segment, idx2) => {
                                                return openBlock(), createElementBlock("div", {
                                                  key: `trail-${idx2}`,
                                                  class: "w-2 h-2 rounded-full bg-green-300 animate-fade-in-up",
                                                  style: normalizeStyle({
                                                    ...getSnakeSegmentPositionStyle(segment),
                                                    animationDelay: `${idx2 * 100}ms`,
                                                    opacity: Math.max(0.3, 1 - idx2 * 0.1)
                                                  })
                                                }, null, 4);
                                              }), 128))
                                            ])
                                          ...
                                          createBaseVNode("div", _hoisted_64, [
                                            ...
                                            e.extra.snakeGame.direction ? (openBlock(), createElementBlock("span", _hoisted_65, " Direction: " + toDisplayString(getDirectionName(e.extra.snakeGame.direction)), 1)) : createCommentVNode("", true)
                                          ])
                                        ])
                                      ])
                                    ])) : createCommentVNode("", true),
                                    e.notes ? (openBlock(), createElementBlock("div", _hoisted_66, toDisplayString(e.notes), 1)) : createCommentVNode("", true)
                                  ]),
                                  createBaseVNode("div", _hoisted_67, [
                                    createBaseVNode("span", {
                                      ...
                                      e.isCorrect ? (openBlock(), createElementBlock("svg", _hoisted_68, _cache[12] || (_cache[12] = [
                                        createBaseVNode("path", { d: "M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" }, null, -1)
                                      ]))) : (openBlock(), createElementBlock("svg", _hoisted_69, _cache[13] || (_cache[13] = [
                                    ...
                                    createBaseVNode("span", _hoisted_70, toDisplayString(new Date(e.timestamp).toLocaleString()), 1)
                                  ])
                                ])
                              ]);
                            }), 128))
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  zoomOpen.value ? (openBlock(), createElementBlock("div", _hoisted_71, [
                    createVNode(Transition, {
                      "enter-active-class": "transition-all duration-500 ease-out",
                      "enter-from-class": "opacity-0 scale-95 translate-y-4",
                      "enter-to-class": "opacity-100 scale-100 translate-y-0",
                          ...
                          createBaseVNode("div", _hoisted_72, [
                            ...
                            createBaseVNode("div", _hoisted_77, [
                              createBaseVNode("div", _hoisted_78, [
                                zoomImage.value ? (openBlock(), createElementBlock("div", _hoisted_79, [
                                  createBaseVNode("img", {
                                    src: zoomImage.value,
                                    alt: unref(t)("flashcard.pictionary.imageAlt", "Pictionary image"),
                                    ...
                                    (openBlock(true), createElementBlock(Fragment, null, renderList(zoomSlots.value, (slot, sIdx) => {
                                      return openBlock(), createElementBlock(Fragment, null, [
                                        slot.separator ? (openBlock(), createElementBlock("div", {
                                          ...
                                          createBaseVNode("span", _hoisted_83, toDisplayString(slot.char || " "), 1)
                                        ], 2))
                                      ], 64);
                                    }), 256))
                                  ])
...
//# sourceMappingURL=SessionDetailModal-DKc9IEl6.js.map
