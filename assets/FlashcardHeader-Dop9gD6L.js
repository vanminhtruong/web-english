...
const _hoisted_37 = { class: "hidden sm:flex items-center justify-between" };
const _hoisted_38 = { class: "flex items-center" };
const _hoisted_39 = { class: "text-2xl md:text-3xl font-bold text-gray-900 dark:text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400" };
const _hoisted_40 = { class: "mt-1 md:mt-2 text-sm md:text-base text-gray-600 dark:text-white/70" };
const _hoisted_41 = { class: "flex items-center space-x-3 md:space-x-4" };
const _hoisted_42 = ["title"];
const _hoisted_43 = { class: "flex items-center space-x-2 md:space-x-3" };
const _hoisted_44 = { class: "text-sm md:text-base text-gray-600 dark:text-white/70" };
const _hoisted_45 = ["disabled", "title"];
const _hoisted_46 = { class: "text-right" };
const _hoisted_47 = { class: "text-sm md:text-base text-gray-500 dark:text-white/60" };
const _hoisted_48 = { class: "text-lg md:text-xl font-semibold text-gray-900 dark:text-white" };
const _hoisted_49 = { class: "flex items-center space-x-2 md:space-x-3" };
const _hoisted_50 = { class: "relative" };
const _hoisted_51 = ["disabled", "aria-disabled", "title", "aria-label"];
const _hoisted_52 = { class: "truncate" };
const _hoisted_53 = {
  key: 0,
...
const _hoisted_54 = { class: "py-1 text-sm text-gray-900 dark:text-white" };
const _hoisted_55 = { class: "px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-3" };
const _hoisted_56 = ["title", "aria-label"];
const _hoisted_57 = { class: "px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-3" };
const _hoisted_58 = ["title", "aria-label"];
const _hoisted_59 = { class: "px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10 flex items-center justify-between gap-3" };
const _hoisted_60 = ["disabled", "aria-disabled", "title"];
...
const _hoisted_71 = ["disabled", "aria-disabled", "title"];
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_10, [
              ...
              createBaseVNode("div", _hoisted_14, [
                        ...
                        createBaseVNode("ul", _hoisted_19, [
                          ...
                          createBaseVNode("li", _hoisted_30, [
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[12] || (_cache[12] = ($event) => selectMode("bubble-shooter")),
                            ...
                            }, toDisplayString(unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter")), 11, _hoisted_31),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-4 w-8 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                              ...
                              onClick: _cache[13] || (_cache[13] = withModifiers(($event) => bubbleShooterModeAvailable.value && toggleBubbleShooterVietnameseMode(), ["stop"])),
                          ...
                          createBaseVNode("li", _hoisted_33, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[14] || (_cache[14] = ($event) => selectMode("snake-game")),
                              title: unref(t)("flashcard.modes.snakeGame", "Snake Hunt")
                            }, toDisplayString(unref(t)("flashcard.modes.snakeGame", "Snake Hunt")), 9, _hoisted_34),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-4 w-8 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                              ...
                              onClick: _cache[15] || (_cache[15] = withModifiers(($event) => toggleSnakeDoubleBaitFromDropdown(), ["stop"])),
                          ...
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[16] || (_cache[16] = ($event) => selectMode("pronunciation"))
                ...
                createBaseVNode("button", {
                  onClick: _cache[17] || (_cache[17] = ($event) => _ctx.$emit("toggle-shuffle")),
                  disabled: _ctx.practiceStarted,
          ...
          createBaseVNode("div", _hoisted_37, [
            createBaseVNode("div", _hoisted_38, [
              createBaseVNode("button", {
                onClick: _cache[18] || (_cache[18] = ($event) => _ctx.$emit("go-back")),
              ...
              createBaseVNode("div", null, [
                createBaseVNode("h1", _hoisted_39, toDisplayString(unref(t)("flashcard.modes.flashcard", "Flashcard")), 1),
                createBaseVNode("p", _hoisted_40, toDisplayString(unref(t)("flashcard.header.description", "Practice vocabulary with flashcards")), 1)
              ])
            ]),
            createBaseVNode("div", _hoisted_41, [
              createBaseVNode("button", {
                onClick: _cache[19] || (_cache[19] = ($event) => _ctx.$emit("show-history")),
              ...
              createBaseVNode("div", _hoisted_43, [
                createBaseVNode("span", _hoisted_44, toDisplayString(unref(t)("flashcard.settings.shuffle", "Shuffle")), 1),
                createBaseVNode("button", {
                  onClick: _cache[20] || (_cache[20] = ($event) => _ctx.$emit("toggle-shuffle")),
                  disabled: _ctx.practiceStarted,
                  class: normalizeClass([
              ...
              createBaseVNode("div", _hoisted_46, [
                createBaseVNode("p", _hoisted_47, toDisplayString(unref(t)("flashcard.header.progress", "Progress")), 1),
                createBaseVNode("p", _hoisted_48, toDisplayString(_ctx.currentIndex + 1) + " / " + toDisplayString(_ctx.totalCards), 1)
              ]),
              createBaseVNode("div", _hoisted_49, [
                createBaseVNode("div", _hoisted_50, [
                  createBaseVNode("button", {
                    ...
                    createBaseVNode("span", _hoisted_52, toDisplayString(_ctx.practiceMode === "flashcard" ? unref(t)("flashcard.modes.flashcard", "Flashcard") : _ctx.practiceMode === "quiz" ? unref(t)("flashcard.modes.quiz", "Quiz") : _ctx.practiceMode === "typing" ? unref(t)("flashcard.modes.typing", "Typing") : _ctx.practiceMode === "listening" ? unref(t)("flashcard.modes.listening", "Listening") : _ctx.practiceMode === "image" ? unref(t)("flashcard.modes.image", "Image") : _ctx.practiceMode === "pictionary" ? unref(t)("flashcard.modes.pictionary", "Pictionary") : _ctx.practiceMode === "bubble-shooter" ? unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter") : _ctx.practiceMode === "snake-game" ? unref(t)("flashcard.modes.snakeGame", "Snake Hunt") : unref(t)("flashcard.modes.pronunciation", "Pronunciation")), 1),
                  ...
                  createVNode(Transition, {
                    ...
                    default: withCtx(() => [
                      desktopDropdownOpen.value && !_ctx.practiceStarted ? (openBlock(), createElementBlock("div", _hoisted_53, [
                        createBaseVNode("ul", _hoisted_54, [
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[21] || (_cache[21] = ($event) => selectMode("flashcard"))
                            }, toDisplayString(unref(t)("flashcard.modes.flashcard", "Flashcard")), 1)
                          ]),
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[22] || (_cache[22] = ($event) => selectMode("quiz"))
                            }, toDisplayString(unref(t)("flashcard.modes.quiz", "Quiz")), 1)
                          ]),
                          createBaseVNode("li", _hoisted_55, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[23] || (_cache[23] = ($event) => selectMode("typing"))
                            }, toDisplayString(unref(t)("flashcard.modes.typing", "Typing")), 1),
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[24] || (_cache[24] = withModifiers(($event) => toggleTypingQuizFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.typing.quizToggle", "Multiple Choice"),
                              "aria-label": unref(t)("flashcard.typing.quizToggle", "Multiple Choice")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_57, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[25] || (_cache[25] = ($event) => selectMode("listening"))
                            }, toDisplayString(unref(t)("flashcard.modes.listening", "Listening")), 1),
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[26] || (_cache[26] = withModifiers(($event) => toggleListeningQuizFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.listening.quizToggle", "Multiple Choice"),
                              "aria-label": unref(t)("flashcard.listening.quizToggle", "Multiple Choice")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_59, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !imageModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[27] || (_cache[27] = ($event) => selectMode("image")),
                              disabled: !imageModeAvailable.value,
                              "aria-disabled": !imageModeAvailable.value ? "true" : "false",
                              title: !imageModeAvailable.value ? unref(t)("flashcard.image.unavailable", "Image mode is unavailable for the selected date") : unref(t)("flashcard.modes.image", "Image")
                            }, toDisplayString(unref(t)("flashcard.modes.image", "Image")), 11, _hoisted_60),
                            createBaseVNode("button", {
                              ...
                              onClick: _cache[28] || (_cache[28] = withModifiers(($event) => imageModeAvailable.value && toggleImageQuizFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.image.quizToggle", "Multiple Choice"),
                              "aria-label": unref(t)("flashcard.image.quizToggle", "Multiple Choice")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_62, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !pictionaryModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[29] || (_cache[29] = ($event) => selectMode("pictionary")),
                              disabled: !pictionaryModeAvailable.value,
                              "aria-disabled": !pictionaryModeAvailable.value ? "true" : "false",
                              title: !pictionaryModeAvailable.value ? unref(t)("flashcard.pictionary.unavailable", "Pictionary mode is unavailable for the selected date") : unref(t)("flashcard.modes.pictionary", "Pictionary")
                            }, toDisplayString(unref(t)("flashcard.modes.pictionary", "Pictionary")), 11, _hoisted_63),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                pictionaryModeAvailable.value ? pictionaryDefinitionMode.value ? "bg-teal-600" : "bg-gray-200 dark:bg-[#0a0a0a]" : "opacity-50 cursor-not-allowed pointer-events-none bg-gray-200 dark:bg-[#0a0a0a]"
                              ]]),
                              onClick: _cache[30] || (_cache[30] = withModifiers(($event) => pictionaryModeAvailable.value && togglePictionaryDefinitionModeFromDropdown(), ["stop"])),
                              title: unref(t)("flashcard.pictionary.definitionToggle", "Definition Mode"),
                              "aria-label": unref(t)("flashcard.pictionary.definitionToggle", "Definition Mode")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_65, [
                            createBaseVNode("button", {
                              class: normalizeClass(["text-left flex-1 truncate", !bubbleShooterModeAvailable.value ? "opacity-50 cursor-not-allowed" : ""]),
                              onClick: _cache[31] || (_cache[31] = ($event) => selectMode("bubble-shooter")),
                              disabled: !bubbleShooterModeAvailable.value,
                              "aria-disabled": !bubbleShooterModeAvailable.value ? "true" : "false",
                              title: !bubbleShooterModeAvailable.value ? unref(t)("flashcard.bubbleShooter.unavailable", "Bubble Shooter mode is disabled for dates with more than 8 vocabulary words") : unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter")
                            }, toDisplayString(unref(t)("flashcard.modes.bubbleShooter", "Bubble Shooter")), 11, _hoisted_66),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                bubbleShooterModeAvailable.value ? bubbleShooterVietnameseMode.value ? "bg-orange-600" : "bg-gray-200 dark:bg-[#0a0a0a]" : "opacity-50 cursor-not-allowed pointer-events-none bg-gray-200 dark:bg-[#0a0a0a]"
                              ]]),
                              onClick: _cache[32] || (_cache[32] = withModifiers(($event) => bubbleShooterModeAvailable.value && toggleBubbleShooterVietnameseMode(), ["stop"])),
                              title: unref(t)("flashcard.bubbleShooter.vietnameseModeToggle", "Vietnamese First Letter Mode"),
                              "aria-label": unref(t)("flashcard.bubbleShooter.vietnameseModeToggle", "Vietnamese First Letter Mode")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", _hoisted_68, [
                            createBaseVNode("button", {
                              class: "text-left flex-1 truncate",
                              onClick: _cache[33] || (_cache[33] = ($event) => selectMode("snake-game")),
                              title: unref(t)("flashcard.modes.snakeGame", "Snake Hunt")
                            }, toDisplayString(unref(t)("flashcard.modes.snakeGame", "Snake Hunt")), 9, _hoisted_69),
                            createBaseVNode("button", {
                              class: normalizeClass(["relative inline-flex h-5 w-10 items-center rounded-full transition-colors border border-gray-300 dark:border-gray-600", [
                                snakeDoubleBaitEnabled.value ? "bg-emerald-600" : "bg-gray-200 dark:bg-[#0a0a0a]",
                                _ctx.practiceStarted ? "opacity-50 cursor-not-allowed pointer-events-none" : ""
                              ]]),
                              onClick: _cache[34] || (_cache[34] = withModifiers(($event) => toggleSnakeDoubleBaitFromDropdown(), ["stop"])),
                              title: _ctx.practiceStarted ? unref(t)("flashcard.settings.disabledDuringPractice", "Settings are disabled during practice") : unref(t)("flashcard.snake.doubleBaitToggle", "Double Bait Mode"),
                              "aria-label": unref(t)("flashcard.snake.doubleBaitToggle", "Double Bait Mode")
                            }, [
                              createBaseVNode("span", {
                          ...
                          createBaseVNode("li", null, [
                            createBaseVNode("button", {
                              class: "w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10",
                              onClick: _cache[35] || (_cache[35] = ($event) => selectMode("pronunciation"))
                            }, toDisplayString(unref(t)("flashcard.modes.pronunciation", "Pronunciation")), 1)
                          ])
                        ])
                      ])) : createCommentVNode("", true)
...
//# sourceMappingURL=FlashcardHeader-Dop9gD6L.js.map
