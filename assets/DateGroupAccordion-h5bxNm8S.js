const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/VocabularyCard-B6MQNy4E.js","assets/vendor-DoTKyHPB.js","assets/index-6sn90GCG.js","assets/vendor-toast-D1B2ty4j.js","assets/vendor-toast-jG2HNJHr.css","assets/index-CHKx_-Aa.css","assets/VocabularyCard-BJpZ1tLY.css","assets/VocabularyNoteButton-Cj1fi7xp.js","assets/GrammarManagerButton-BlalyMdu.js"])))=>i.map(i=>d[i]);
import { f as getDateKey, g as getTopicName, l as loadComponentSafely, _ as __vitePreload, a as _export_sfc } from "./index-6sn90GCG.js";
...
const _hoisted_77 = ["onMouseenter"];
const _hoisted_78 = ["aria-label"];
const _hoisted_79 = { class: "text-xs font-semibold mb-2" };
const _hoisted_80 = {
  key: 0,
  class: "text-xs text-gray-600 dark:text-white/70"
};
const _hoisted_81 = ["onClick"];
const _hoisted_82 = { class: "text-gray-500 dark:text-white/60" };
const _hoisted_83 = ["onClick", "title"];
const _hoisted_84 = { class: "flex items-center justify-between text-xs" };
const _hoisted_85 = { class: "flex-1 flex justify-between sm:hidden" };
const _hoisted_86 = ["onClick", "disabled"];
const _hoisted_87 = ["onClick", "disabled"];
const _hoisted_88 = { class: "hidden sm:flex-1 sm:flex sm:items-center sm:justify-between" };
const _hoisted_89 = { class: "text-xs text-gray-700 dark:text-gray-300" };
const _hoisted_90 = { class: "relative z-0 inline-flex rounded-md shadow-sm -space-x-px" };
const _hoisted_91 = ["onClick", "disabled"];
const _hoisted_92 = { class: "sr-only" };
...
const _hoisted_97 = { class: "divide-y divide-gray-200 dark:divide-gray-700" };
const _hoisted_98 = {
  key: 1,
  class: "divide-y divide-gray-200 dark:divide-gray-700"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const VocabularyCard = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./VocabularyCard-B6MQNy4E.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0))
    );
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.group.topics, (topicGroup) => {
                    return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("div", {
                          ...
                          createBaseVNode("div", {
                            ...
                            infoHoverTopic.value === topicGroup.topic ? (openBlock(), createElementBlock("div", {
                              ...
                              _cache[78] || (_cache[78] = createBaseVNode("span", {
                                "aria-hidden": "true",
                              ...
                              createBaseVNode("div", _hoisted_79, toDisplayString(unref(t)("vocabulary.sameTopicDatesTitle", "Dates with same topic")), 1),
                              !availableDatesByTopic.value[topicGroup.topic] || availableDatesByTopic.value[topicGroup.topic].length === 0 ? (openBlock(), createElementBlock("div", _hoisted_80, toDisplayString(unref(t)("vocabulary.sameTopicDatesEmpty", "No other dates found for this topic")), 1)) : (openBlock(), createElementBlock("ul", {
                                key: 1,
                                ...
                                (openBlock(true), createElementBlock(Fragment, null, renderList(availableDatesByTopic.value[topicGroup.topic], (d) => {
                                  return openBlock(), createElementBlock("li", {
                                    ...
                                    createBaseVNode("span", _hoisted_82, "(" + toDisplayString(d.count) + ")", 1)
                                  ], 8, _hoisted_81);
                                }), 128))
                              ], 2))
                          ...
                          ]), 8, _hoisted_83)) : createCommentVNode("", true)
                        ], 8, _hoisted_73),
                        isTopicExpanded(topicGroup.topic) && getPaginatedTopicVocabularies(topicGroup).totalPages > 1 ? (openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_84, [
                            createBaseVNode("div", _hoisted_85, [
                              ...
                              }, toDisplayString(unref(t)("common.previous")), 9, _hoisted_86),
                              createBaseVNode("button", {
                                onClick: ($event) => nextTopicPage(topicGroup.topic),
                                disabled: !getPaginatedTopicVocabularies(topicGroup).hasNext,
                                class: "ml-2 relative inline-flex items-center px-2 md:px-2 py-1 md:py-1.5 xl:py-1.5 2xl:py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium rounded text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0a0a0a] hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                              }, toDisplayString(unref(t)("common.next")), 9, _hoisted_87)
                            ]),
                            createBaseVNode("div", _hoisted_88, [
                              createBaseVNode("div", null, [
                                createBaseVNode("p", _hoisted_89, toDisplayString(unref(t)("vocabulary.showingCategoryItems", {
                              ...
                              createBaseVNode("div", null, [
                                createBaseVNode("nav", _hoisted_90, [
                                  createBaseVNode("button", {
                                    onClick: ($event) => previousTopicPage(topicGroup.topic),
                                    disabled: !getPaginatedTopicVocabularies(topicGroup).hasPrevious,
                                    ...
                                    createBaseVNode("span", _hoisted_92, toDisplayString(unref(t)("common.previous")), 1),
                                  ...
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(getVisibleTopicPages(getPaginatedTopicVocabularies(topicGroup).currentPage, getPaginatedTopicVocabularies(topicGroup).totalPages), (page) => {
                                    ...
                                    }, toDisplayString(page === -1 ? "..." : page), 11, _hoisted_93);
                                  }), 128)),
                                  createBaseVNode("button", {
                                    onClick: ($event) => nextTopicPage(topicGroup.topic),
                                    disabled: !getPaginatedTopicVocabularies(topicGroup).hasNext,
                                    ...
                                    createBaseVNode("span", _hoisted_95, toDisplayString(unref(t)("common.next")), 1),
                      ...
                      createVNode(Transition, { name: "topic-accordion" }, {
                        default: withCtx(() => [
                          isTopicExpanded(topicGroup.topic) ? (openBlock(), createElementBlock("div", _hoisted_96, [
...
const DateGroupAccordion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-548e0df4"]]);
export {
  DateGroupAccordion as default
};
//# sourceMappingURL=DateGroupAccordion-h5bxNm8S.js.map
