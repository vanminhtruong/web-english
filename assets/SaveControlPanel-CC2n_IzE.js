import { d as defineComponent, H as useI18n, A as ref, K as watch, I as onMounted, B as computed, c as createElementBlock, v as openBlock, f as createBaseVNode, e as createCommentVNode, t as toDisplayString, u as unref, n as normalizeClass, g as createTextVNode, F as Fragment, j as renderList } from "./vendor-DoTKyHPB.js";
import { googleDriveFileService } from "./googleDriveFileService-C-FNODSl.js";
import { b as useGoogleDriveAuth } from "./index-CieoXZUQ.js";
...
const _hoisted_40 = {
  key: 1,
  class: "text-xs xs:text-sm text-gray-500 dark:text-gray-400 text-center py-2 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg"
};
const _hoisted_41 = { class: "space-y-3 xs:space-y-4" };
const _hoisted_42 = { class: "bg-gray-50 dark:bg-[#0f0f0f] border border-gray-200 dark:border-[#0f0f0f] rounded-lg p-3 xs:p-4" };
const _hoisted_43 = { class: "text-xs xs:text-sm font-medium text-gray-800 dark:text-gray-200 mb-2 xs:mb-3" };
const _hoisted_44 = { class: "space-y-2 xs:space-y-3" };
const _hoisted_45 = { class: "flex items-center space-x-1.5 xs:space-x-2" };
const _hoisted_46 = { class: "text-xs xs:text-sm text-gray-600 dark:text-gray-400" };
const _hoisted_47 = { class: "flex items-center space-x-1.5 xs:space-x-2 text-xs xs:text-sm text-gray-500 dark:text-gray-400" };
...
const _hoisted_50 = { class: "text-xs xs:text-sm font-medium text-indigo-800 dark:text-indigo-400 mb-2 xs:mb-3" };
const _hoisted_51 = { class: "text-xs xs:text-sm text-gray-600 dark:text-gray-400" };
const _hoisted_52 = { class: "mb-1.5 xs:mb-2" };
...
const _hoisted_57 = { class: "bg-white dark:bg-[#0a0a0a] rounded-lg shadow-2xl border border-gray-200 dark:border-[#0f0f0f] max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden" };
const _hoisted_58 = { class: "bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-[#0f0f0f] dark:to-[#0a0a0a] px-6 py-4 border-b border-gray-200 dark:border-[#0f0f0f] flex items-center justify-between" };
const _hoisted_59 = { class: "flex items-center space-x-3" };
const _hoisted_60 = { class: "text-lg font-semibold text-gray-900 dark:text-white" };
const _hoisted_61 = { class: "p-6" };
const _hoisted_62 = {
  key: 0,
...
const _hoisted_64 = { class: "text-sm text-red-800 dark:text-red-400" };
const _hoisted_65 = { class: "space-y-2 max-h-60 overflow-y-auto" };
const _hoisted_66 = {
  key: 0,
  class: "text-center py-8 text-gray-500 dark:text-gray-400"
};
const _hoisted_67 = { class: "text-sm" };
const _hoisted_68 = ["onClick"];
const _hoisted_69 = { class: "flex items-center space-x-3 flex-1" };
const _hoisted_70 = { class: "flex-1 min-w-0" };
const _hoisted_71 = { class: "text-sm font-medium text-gray-900 dark:text-white truncate" };
const _hoisted_72 = { class: "flex items-center space-x-4 text-xs text-gray-500 dark:text-gray-400" };
const _hoisted_73 = { class: "bg-gray-50 dark:bg-[#0f0f0f] px-6 py-4 border-t border-gray-200 dark:border-[#0f0f0f] flex justify-end" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const selectGoogleDriveFile = async (file) => {
      try {
            ...
            createBaseVNode("div", _hoisted_19, [
              ...
              createBaseVNode("div", _hoisted_33, [
                ...
                createBaseVNode("div", _hoisted_35, [
                  ...
                  _ctx.isGoogleSignedIn ? (openBlock(), createElementBlock("button", {
                    key: 0,
                    onClick: openGoogleDrivePicker,
                    disabled: isLoadingGoogleDriveFiles.value,
                    ...
                    isLoadingGoogleDriveFiles.value ? (openBlock(), createElementBlock("svg", _hoisted_38, _cache[18] || (_cache[18] = [
                      createBaseVNode("circle", {
                        class: "opacity-25",
                        cx: "12",
                        cy: "12",
                    ...
                    ]))) : (openBlock(), createElementBlock("svg", _hoisted_39, _cache[19] || (_cache[19] = [
                      createBaseVNode("path", {
                        "stroke-linecap": "round",
                        "stroke-linejoin": "round",
                        "stroke-width": "2",
                    ...
                    createBaseVNode("span", null, toDisplayString(isLoadingGoogleDriveFiles.value ? unref(t)("common.loading", "Loading...") : unref(t)("vocabulary.save.importFromDrive", "Import from Google Drive")), 1)
                  ], 8, _hoisted_37)) : createCommentVNode("", true),
                  !_ctx.isGoogleSignedIn ? (openBlock(), createElementBlock("div", _hoisted_40, toDisplayString(unref(t)("vocabulary.save.signInRequiredForImport", "Sign in to Google Drive to import files")), 1)) : createCommentVNode("", true)
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_41, [
              createBaseVNode("div", _hoisted_42, [
                createBaseVNode("h4", _hoisted_43, toDisplayString(unref(t)("vocabulary.save.status", "Save Status")), 1),
                createBaseVNode("div", _hoisted_44, [
                  createBaseVNode("div", _hoisted_45, [
                    createBaseVNode("div", {
                      class: normalizeClass(["h-2.5 xs:h-3 w-2.5 xs:w-3 rounded-full", _ctx.saveStatusColor])
                    }, null, 2),
                    createBaseVNode("span", _hoisted_46, toDisplayString(_ctx.saveStatusText), 1)
                  ]),
                  createBaseVNode("div", _hoisted_47, [
                    ...
                    createBaseVNode("span", _hoisted_48, toDisplayString(formattedLastSave.value), 1)
                  ])
                ])
              ]),
              _ctx.autoSaveEnabled ? (openBlock(), createElementBlock("div", _hoisted_49, [
                createBaseVNode("h4", _hoisted_50, toDisplayString(unref(t)("vocabulary.save.storageInfo", "Storage Information")), 1),
                createBaseVNode("div", _hoisted_51, [
                  createBaseVNode("p", _hoisted_52, [
                    createBaseVNode("span", _hoisted_53, toDisplayString(unref(t)("vocabulary.save.type", "Type")) + ":", 1),
                  ...
                  _ctx.storageType === "local" && _ctx.hasAutoSaveFile ? (openBlock(), createElementBlock("p", _hoisted_54, " ✓ " + toDisplayString(unref(t)("vocabulary.save.fileConfigured", "Auto-save file configured")), 1)) : createCommentVNode("", true),
                  _ctx.storageType === "google-drive" && _ctx.isGoogleSignedIn ? (openBlock(), createElementBlock("p", _hoisted_55, " ✓ " + toDisplayString(unref(t)("vocabulary.save.googleConnected", "Google Drive connected")), 1)) : createCommentVNode("", true)
                ])
              ])) : createCommentVNode("", true)
            ])
          ])
        ]),
        showGoogleDrivePicker.value ? (openBlock(), createElementBlock("div", _hoisted_56, [
          createBaseVNode("div", _hoisted_57, [
            createBaseVNode("div", _hoisted_58, [
              createBaseVNode("div", _hoisted_59, [
                _cache[21] || (_cache[21] = createBaseVNode("div", { class: "p-2 bg-blue-100 dark:bg-blue-900/20 rounded-lg" }, [
                  createBaseVNode("svg", {
                    class: "h-5 w-5 text-blue-600 dark:text-blue-400",
                    fill: "none",
                    stroke: "currentColor",
                ...
                createBaseVNode("h3", _hoisted_60, toDisplayString(unref(t)("vocabulary.save.selectFromDrive", "Select from Google Drive")), 1)
              ]),
              createBaseVNode("button", {
                onClick: closeGoogleDrivePicker,
            ...
            createBaseVNode("div", _hoisted_61, [
              googleDriveError.value ? (openBlock(), createElementBlock("div", _hoisted_62, [
                createBaseVNode("div", _hoisted_63, [
                  ...
                  createBaseVNode("p", _hoisted_64, toDisplayString(googleDriveError.value), 1)
                ])
              ])) : createCommentVNode("", true),
              createBaseVNode("div", _hoisted_65, [
                googleDriveFiles.value.length === 0 && !isLoadingGoogleDriveFiles.value ? (openBlock(), createElementBlock("div", _hoisted_66, [
                  ...
                  createBaseVNode("p", _hoisted_67, toDisplayString(unref(t)("vocabulary.save.noFilesFound", "No JSON files found in Google Drive")), 1)
                ])) : createCommentVNode("", true),
                (openBlock(true), createElementBlock(Fragment, null, renderList(googleDriveFiles.value, (file) => {
                  return openBlock(), createElementBlock("div", {
                    key: file.id,
                    onClick: ($event) => selectGoogleDriveFile(file),
                    ...
                    createBaseVNode("div", _hoisted_69, [
                      _cache[25] || (_cache[25] = createBaseVNode("div", { class: "p-2 bg-green-100 dark:bg-green-900/20 rounded" }, [
                        createBaseVNode("svg", {
                      ...
                      createBaseVNode("div", _hoisted_70, [
                        createBaseVNode("p", _hoisted_71, toDisplayString(file.name), 1),
                        createBaseVNode("div", _hoisted_72, [
                          createBaseVNode("span", null, toDisplayString(file.size), 1),
                          createBaseVNode("span", null, toDisplayString(file.modifiedTime), 1)
                        ])
                      ])
                    ]),
...
//# sourceMappingURL=SaveControlPanel-CC2n_IzE.js.map
