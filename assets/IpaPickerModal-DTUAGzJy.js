...
import { e as useVoiceStore } from "./index-CwJxeNzi.js";
...
const _hoisted_30 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2 flex items-center" };
const _hoisted_31 = { class: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2" };
const _hoisted_32 = ["onClick", "title"];
const _hoisted_33 = { class: "font-bold text-base" };
const _hoisted_34 = { class: "text-xs text-gray-600 dark:text-gray-400" };
const _hoisted_35 = ["onClick", "title"];
const _hoisted_36 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2 flex items-center" };
                              ...
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredConsonants.value, (consonant) => {
                                return openBlock(), createElementBlock("div", {
                                  ...
                                  createBaseVNode("button", {
                                    ...
                                    createBaseVNode("span", _hoisted_33, toDisplayString(consonant.symbol), 1),
                                    createBaseVNode("span", _hoisted_34, toDisplayString(consonant.letter), 1)
                                  ], 8, _hoisted_32),
                                  createBaseVNode("button", {
                                    type: "button",
                          ...
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_37, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(IPA_MARKS, (mark) => {
                                ...
                                }, toDisplayString(mark === " " ? unref(t)("common.space", "Space") : mark), 9, _hoisted_38);
                              }), 64))
                            ])
                          ])
                        ])
...
//# sourceMappingURL=IpaPickerModal-DTUAGzJy.js.map
