const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FireworkSoundEffect-DG9n_Ru2.js","assets/vendor-DoTKyHPB.js","assets/index-BuG_nsbx.js","assets/vendor-toast-D1B2ty4j.js","assets/vendor-toast-jG2HNJHr.css","assets/index-BxRAaklO.css","assets/FireworkSoundEffect-Z17vpFMM.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e as useVoiceStore, a as _export_sfc } from "./index-BuG_nsbx.js";
import { d as defineComponent, H as useI18n, A as ref, B as computed, K as watch, I as onMounted, q as nextTick, c as createElementBlock, v as openBlock, f as createBaseVNode, e as createCommentVNode, y as createVNode, t as toDisplayString, u as unref, F as Fragment, j as renderList, n as normalizeClass, C as withDirectives, S as vModelText, Z as withKeys, g as createTextVNode, D as defineAsyncComponent, i as withModifiers } from "./vendor-DoTKyHPB.js";
...
const _hoisted_11 = { class: "text-sm text-gray-500 dark:text-white/60 mt-2" };
const _hoisted_12 = {
  key: 1,
...
const _hoisted_13 = { class: "text-center space-y-3" };
const _hoisted_14 = { class: "max-h-32 overflow-y-auto" };
const _hoisted_15 = { class: "text-lg font-medium text-gray-900 dark:text-white leading-relaxed" };
const _hoisted_16 = {
  key: 2,
...
const _hoisted_20 = { class: "flex flex-wrap gap-3 justify-center items-center" };
const _hoisted_21 = {
  key: 0,
  class: "px-1 text-lg text-gray-700 dark:text-white/80 select-none"
};
const _hoisted_22 = ["onClick"];
const _hoisted_23 = { class: "tile-face tile-back absolute inset-0 flex items-center justify-center rounded-lg border-2 bg-white dark:bg-dark-bg-soft border-green-400 dark:border-green-500 shadow-lg text-2xl font-bold text-gray-900 dark:text-white" };
const _hoisted_24 = {
  key: 0,
  class: "flex-shrink-0 mb-4"
};
const _hoisted_25 = { class: "max-w-md mx-auto" };
...
const _hoisted_32 = { class: "text-sm text-gray-600 dark:text-white/70" };
const _hoisted_33 = { class: "font-semibold text-gray-900 dark:text-white" };
const _hoisted_34 = { class: "text-xs text-gray-500 dark:text-white/60 mt-1 line-clamp-2" };
const _hoisted_35 = {
  key: 1,
  class: "text-center"
};
const _hoisted_36 = { class: "text-sm text-gray-600 dark:text-white/70 line-clamp-2" };
const _hoisted_37 = {
  key: 2,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const FireworkSoundEffect = defineAsyncComponent(() => __vitePreload(() => import("./FireworkSoundEffect-DG9n_Ru2.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1, [
          ...
          createBaseVNode("div", _hoisted_6, [
            _ctx.card?.image ? (openBlock(), createElementBlock("div", _hoisted_7, [
              createBaseVNode("img", {
                src: _ctx.card.image,
              ...
              imageError.value ? (openBlock(), createElementBlock("div", _hoisted_9, [
                createBaseVNode("div", _hoisted_10, [
                  ...
                  createBaseVNode("p", _hoisted_11, toDisplayString(unref(t)("flashcard.image.imageError", "Could not load image.")), 1)
                ])
              ])) : createCommentVNode("", true)
            ])) : _ctx.card?.meaning ? (openBlock(), createElementBlock("div", _hoisted_12, [
              createBaseVNode("div", _hoisted_13, [
                _cache[5] || (_cache[5] = createBaseVNode("div", { class: "mx-auto w-12 h-12 bg-teal-100 dark:bg-teal-800/50 rounded-full flex items-center justify-center mb-4" }, [
                  createBaseVNode("svg", {
                ...
                createBaseVNode("div", _hoisted_14, [
                  createBaseVNode("p", _hoisted_15, toDisplayString(_ctx.card?.meaning || unref(t)("flashcard.flipTile.noDefinition", "No definition available")), 1)
                ])
              ])
            ...
            createBaseVNode("div", _hoisted_20, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(tiles.value, (tile, idx) => {
                return openBlock(), createElementBlock("div", { key: idx }, [
                  tile.separator ? (openBlock(), createElementBlock("div", _hoisted_21, toDisplayString(tile.char), 1)) : (openBlock(), createElementBlock("div", {
                    key: 1,
                    class: normalizeClass(["relative w-12 h-14 sm:w-14 sm:h-16 transition-all duration-500 tile-3d", [{ "cursor-pointer": !tile.flipped && canFlipMore.value }, tile.flipped ? "is-flipped" : "hover:shadow-xl hover:scale-105"]]),
                    ...
                    createBaseVNode("div", _hoisted_23, toDisplayString(tile.char.toUpperCase()), 1)
                  ], 10, _hoisted_22))
                ]);
              }), 128))
            ])
          ]),
          !_ctx.flipTileAnswered ? (openBlock(), createElementBlock("div", _hoisted_24, [
          ...
          _ctx.flipTileAnswered ? (openBlock(), createElementBlock("div", _hoisted_28, [
            createBaseVNode("div", {
              ...
              _ctx.flipTileCorrect ? (openBlock(), createElementBlock("svg", _hoisted_29, _cache[8] || (_cache[8] = [
                createBaseVNode("path", {
                  "fill-rule": "evenodd",
                  d: "M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z",
                  "clip-rule": "evenodd"
                }, null, -1)
              ]))) : (openBlock(), createElementBlock("svg", _hoisted_30, _cache[9] || (_cache[9] = [
                createBaseVNode("path", {
                  "fill-rule": "evenodd",
            ...
            !_ctx.flipTileCorrect ? (openBlock(), createElementBlock("div", _hoisted_31, [
              createBaseVNode("p", _hoisted_32, [
                createTextVNode(toDisplayString(unref(t)("flashcard.image.correctAnswer", "Correct answer")) + ": ", 1),
                createBaseVNode("span", _hoisted_33, toDisplayString(_ctx.card?.word), 1)
              ]),
              createBaseVNode("p", _hoisted_34, toDisplayString(_ctx.card?.meaning), 1)
            ])) : (openBlock(), createElementBlock("div", _hoisted_35, [
              createBaseVNode("p", _hoisted_36, toDisplayString(_ctx.card?.meaning), 1)
            ]))
          ])) : createCommentVNode("", true),
          !_ctx.flipTileAnswered ? (openBlock(), createElementBlock("p", _hoisted_37, toDisplayString(unref(t)("flashcard.flipTile.instruction", `Click on tiles to reveal letters (max ${maxFlips.value}), then type your answer and press Enter.`)), 1)) : createCommentVNode("", true),
...
const FlipTileMode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4458d9c8"]]);
export {
  FlipTileMode as default
};
//# sourceMappingURL=FlipTileMode-Dmn_xyrd.js.map
