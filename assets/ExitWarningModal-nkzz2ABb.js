import { d as defineComponent, H as useI18n, c as createElementBlock, e as createCommentVNode, v as openBlock, f as createBaseVNode, t as toDisplayString, u as unref } from "./vendor-vEVloz7Q.js";
const _hoisted_1 = {
  key: 0,
  class: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
};
const _hoisted_2 = { class: "bg-white dark:bg-[#0a0a0a] rounded-xl p-8 max-w-md mx-4 text-center" };
const _hoisted_3 = { class: "text-xl font-bold text-gray-900 dark:text-white mb-2" };
const _hoisted_4 = { class: "text-gray-600 dark:text-white/80 mb-6" };
...
//# sourceMappingURL=ExitWarningModal-nkzz2ABb.js.map
