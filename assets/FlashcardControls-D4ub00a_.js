import { d as defineComponent, H as useI18n, c as createElementBlock, v as openBlock, e as createCommentVNode, F as Fragment, f as createBaseVNode, u as unref, t as toDisplayString, n as normalizeClass } from "./vendor-DoTKyHPB.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _ctx.practiceMode === "flashcard" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          }, toDisplayString(_ctx.currentIndex === _ctx.totalCards - 1 ? unref(t)("practice.controls.complete", "Complete") : unref(t)("practice.controls.next", "Next")), 1),
          createBaseVNode("button", {
        ...
        ], 64)) : ["quiz", "typing", "listening", "image", "pronunciation", "pictionary"].includes(_ctx.practiceMode) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          createBaseVNode("button", {
          ...
          createBaseVNode("button", {
            ...
            class: normalizeClass(["bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 dark:disabled:bg-gray-700 text-white px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-full font-medium transition-colors text-xs sm:text-sm md:text-base", ["quiz", "typing", "listening", "image", "pictionary"].includes(_ctx.practiceMode) ? "hidden md:inline-flex" : ""])
...
//# sourceMappingURL=FlashcardControls-D4ub00a_.js.map
