...
const _hoisted_6 = { class: "px-5 py-4 space-y-4 overflow-y-auto flex-1 min-h-0" };
const _hoisted_7 = { class: "p-3 rounded-lg border border-gray-200 dark:border-dark-bg-mute bg-white dark:bg-dark-bg-mute" };
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_2, [
                    createBaseVNode("div", {
                      class: "bg-white dark:bg-dark-bg-soft shadow-2xl rounded-xl border border-gray-200 dark:border-dark-bg-mute overflow-hidden transform flex flex-col max-sm:max-h-[80vh] max-xs:max-h-[75vh]",
                            ...
                            createBaseVNode("div", _hoisted_16, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(IPA_VOWELS, (s) => {
                                return createBaseVNode("button", {
                                  ...
                                  class: "px-2.5 py-1.5 rounded-md border border-gray-300 dark:border-dark-bg-mute text-gray-900 dark:text-white dark:bg-dark-bg-mute hover:bg-gray-100 dark:hover:bg-dark-bg-soft"
...
//# sourceMappingURL=IpaPickerModal-B5ByNvLh.js.map
