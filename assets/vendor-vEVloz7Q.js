...
function createRouter(options) {
  ...
  function setupListeners() {
    ...
    removeHistoryListener = routerHistory.listen((to, _from, info) => {
      ...
      if (shouldRedirect) {
        pushWithRedirect(assign$1(shouldRedirect, { replace: true, force: true }), toLocation).catch(noop);
        return;
      }
...
const VERSION$1 = "12.0.0-alpha.3";
...
(function main(global2, module2, isWorker, workerSize) {
  ...
  function updateFetti(context, fetti) {
    ...
    if (canUsePaths && fetti.shape.type === "path" && typeof fetti.shape.path === "string" && Array.isArray(fetti.shape.matrix)) {
      ...
      matrix2.multiplySelf(new DOMMatrix(fetti.shape.matrix));
...
//# sourceMappingURL=vendor-vEVloz7Q.js.map
