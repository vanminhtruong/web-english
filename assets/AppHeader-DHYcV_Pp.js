const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ThemeToggle-DDFF0lxw.js","assets/index-CRibYnh9.js","assets/vendor-DI3yOcyn.js","assets/vendor-toast-BpLwVhAX.js","assets/vendor-toast-jG2HNJHr.css","assets/index-DLpj-S53.css","assets/ThemeToggle-DSsMUYxu.css","assets/LanguageSwitcher-CryRLFLX.js"])))=>i.map(i=>d[i]);
import { l as loadComponentSafely, _ as __vitePreload, a as _export_sfc } from "./index-CRibYnh9.js";
import { d as defineComponent, H as useI18n, Q as useRoute, G as useRouter, A as ref, I as onMounted, L as onUnmounted, K as watch, B as computed, c as createElementBlock, v as openBlock, f as createBaseVNode, C as withDirectives, u as unref, Z as withKeys, i as withModifiers, F as Fragment, j as renderList, a as normalizeStyle, n as normalizeClass, t as toDisplayString, y as createVNode, w as withCtx, g as createTextVNode, _ as RouterLink, D as defineAsyncComponent, E as vShow } from "./vendor-DI3yOcyn.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ThemeToggle = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./ThemeToggle-DDFF0lxw.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0))
    );
    const LanguageSwitcher = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./LanguageSwitcher-CryRLFLX.js"), true ? __vite__mapDeps([7,1,2,3,4,5]) : void 0))
    );
    const { t } = useI18n();
...
//# sourceMappingURL=AppHeader-DHYcV_Pp.js.map
