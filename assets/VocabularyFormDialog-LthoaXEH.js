...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const ImageUpload = defineAsyncComponent(() => __vitePreload(() => import("./ImageUpload-BI5y-xyL.js"), true ? __vite__mapDeps([0,1]) : void 0));
    const TopicManager = defineAsyncComponent(() => __vitePreload(() => import("./TopicManager-CG9mQIEW.js"), true ? __vite__mapDeps([2,1,3,4,5,6,7]) : void 0));
    const props = __props;
    const emit = __emit;
    const { t } = useI18n();
...
//# sourceMappingURL=VocabularyFormDialog-LthoaXEH.js.map
