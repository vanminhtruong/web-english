const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FireworkSoundEffect-Biby_-jG.js","assets/vendor-DMqe9Z5T.js","assets/index-BnGNe7KO.js","assets/vendor-toast-C02QcIAu.js","assets/vendor-toast-jG2HNJHr.css","assets/index-CNMDS1BC.css","assets/FireworkSoundEffect-Z17vpFMM.css"])))=>i.map(i=>d[i]);
import { g as getTopicName, _ as __vitePreload, e as useVoiceStore, a as _export_sfc } from "./index-BnGNe7KO.js";
...
const _hoisted_12 = { class: "flex flex-wrap justify-center items-center gap-1 sm:gap-2 mb-2 sm:mb-3 md:mb-4 min-h-[3rem] max-w-full px-2 sm:px-0" };
...
const _hoisted_26 = { class: "flex justify-center flex-wrap gap-2 sm:gap-3 md:gap-4 xl:gap-3 2xl:gap-3 mb-4 sm:mb-5 md:mb-6 px-2 sm:px-4 md:px-6 xl:px-8 2xl:px-12 max-w-full" };
const _hoisted_27 = ["onClick", "disabled"];
const _hoisted_28 = { class: "flex flex-wrap justify-center gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 px-2 sm:px-4 max-w-full" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const props = __props;
    const emit = __emit;
    const FireworkSoundEffect = defineAsyncComponent(() => __vitePreload(() => import("./FireworkSoundEffect-Biby_-jG.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
...
const FlashcardCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-651bed15"]]);
export {
  FlashcardCard as default
};
//# sourceMappingURL=FlashcardCard-CN-BXPP2.js.map
