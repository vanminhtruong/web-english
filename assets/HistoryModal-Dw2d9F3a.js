import { d as defineComponent, H as useI18n, c as createElementBlock, v as openBlock, y as createVNode, w as withCtx, e as createCommentVNode, M as Transition, f as createBaseVNode, i as withModifiers, t as toDisplayString, u as unref, F as Fragment, j as renderList, n as normalizeClass } from "./vendor-vEVloz7Q.js";
const _hoisted_1 = {
  key: 0,
...
const _hoisted_17 = { class: "grid grid-cols-2 md:grid-cols-4 gap-4 text-sm" };
const _hoisted_18 = { class: "text-gray-500 dark:text-white/70" };
const _hoisted_19 = { class: "ml-1 font-medium text-gray-900 dark:text-white" };
const _hoisted_20 = { class: "text-gray-500 dark:text-white/70" };
const _hoisted_21 = { class: "ml-1 font-medium text-green-600 dark:text-green-400" };
const _hoisted_22 = { class: "text-gray-500 dark:text-white/70" };
const _hoisted_23 = { class: "ml-1 font-medium text-red-600 dark:text-red-400" };
const _hoisted_24 = { class: "text-gray-500 dark:text-white/70" };
const _hoisted_25 = { class: "ml-1 font-medium text-gray-900 dark:text-white" };
const _hoisted_26 = { class: "mt-2" };
const _hoisted_27 = { class: "text-gray-500 dark:text-white/70 text-sm" };
const _hoisted_28 = { class: "flex flex-wrap gap-1 mt-1" };
const _hoisted_29 = { class: "text-right" };
const _hoisted_30 = { class: "text-lg font-bold text-gray-900 dark:text-white" };
const _hoisted_31 = { class: "text-xs text-gray-500 dark:text-white/70" };
                        ...
                        _ctx.history.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_8, [
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.history, (session) => {
                            return openBlock(), createElementBlock("div", {
                              key: session.id,
                              class: "bg-gray-50 dark:bg-gray-custom rounded-lg p-4"
                            }, [
                              createBaseVNode("div", _hoisted_12, [
                                createBaseVNode("div", _hoisted_13, [
                                  ...
                                  createBaseVNode("div", _hoisted_17, [
                                    createBaseVNode("div", null, [
                                      createBaseVNode("span", _hoisted_18, toDisplayString(unref(t)("flashcard.history.totalCards", "Total Cards")) + ":", 1),
                                      createBaseVNode("span", _hoisted_19, toDisplayString(session.totalCards), 1)
                                    ]),
                                    createBaseVNode("div", null, [
                                      createBaseVNode("span", _hoisted_20, toDisplayString(unref(t)("flashcard.history.correct", "Correct")) + ":", 1),
                                      createBaseVNode("span", _hoisted_21, toDisplayString(session.correctAnswers), 1)
                                    ]),
                                    createBaseVNode("div", null, [
                                      createBaseVNode("span", _hoisted_22, toDisplayString(unref(t)("flashcard.history.incorrect", "Incorrect")) + ":", 1),
                                      createBaseVNode("span", _hoisted_23, toDisplayString(session.incorrectAnswers), 1)
                                    ]),
                                    createBaseVNode("div", null, [
                                      createBaseVNode("span", _hoisted_24, toDisplayString(unref(t)("flashcard.history.duration", "Duration")) + ":", 1),
                                      createBaseVNode("span", _hoisted_25, toDisplayString(_ctx.formatDuration(session.duration)), 1)
                                    ])
                                  ]),
                                  createBaseVNode("div", _hoisted_26, [
                                    createBaseVNode("span", _hoisted_27, toDisplayString(unref(t)("flashcard.history.categories", "Categories")) + ":", 1),
                                ...
                                createBaseVNode("div", _hoisted_29, [
                                  createBaseVNode("div", _hoisted_30, toDisplayString(Math.round(session.correctAnswers / session.totalCards * 100)) + "% ", 1),
                                  createBaseVNode("div", _hoisted_31, toDisplayString(unref(t)("flashcard.history.accuracy", "Accuracy")), 1),
...
//# sourceMappingURL=HistoryModal-Dw2d9F3a.js.map
