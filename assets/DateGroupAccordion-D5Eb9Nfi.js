const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/VocabularyCard-Dxtzsuhx.js","assets/vendor-DoTKyHPB.js","assets/index-CuT7CdFb.js","assets/vendor-toast-D1B2ty4j.js","assets/vendor-toast-jG2HNJHr.css","assets/index-QWkG18kn.css","assets/VocabularyCard-Cw2LB8Qy.css","assets/VocabularyNoteButton-Cj1fi7xp.js","assets/GrammarManagerButton-BlalyMdu.js"])))=>i.map(i=>d[i]);
import { f as getDateKey, g as getTopicName, l as loadComponentSafely, _ as __vitePreload, a as _export_sfc } from "./index-CuT7CdFb.js";
import { d as defineComponent, H as useI18n, B as computed, A as ref, K as watch, I as onMounted, q as nextTick, L as onUnmounted, c as createElementBlock, v as openBlock, f as createBaseVNode, y as createVNode, e as createCommentVNode, n as normalizeClass, t as toDisplayString, i as withModifiers, C as withDirectives, N as vModelCheckbox, S as vModelText, u as unref, Z as withKeys, g as createTextVNode, D as defineAsyncComponent, F as Fragment, w as withCtx, j as renderList, M as Transition, b as createBlock } from "./vendor-DoTKyHPB.js";
...
const _hoisted_75 = { class: "text-sm font-medium text-gray-600 dark:text-gray-400" };
const _hoisted_76 = { class: "text-xs text-gray-500" };
const _hoisted_77 = ["onClick", "title"];
const _hoisted_78 = { class: "flex items-center justify-between text-xs" };
const _hoisted_79 = { class: "flex-1 flex justify-between sm:hidden" };
const _hoisted_80 = ["onClick", "disabled"];
const _hoisted_81 = ["onClick", "disabled"];
const _hoisted_82 = { class: "hidden sm:flex-1 sm:flex sm:items-center sm:justify-between" };
const _hoisted_83 = { class: "text-xs text-gray-700 dark:text-gray-300" };
const _hoisted_84 = { class: "relative z-0 inline-flex rounded-md shadow-sm -space-x-px" };
const _hoisted_85 = ["onClick", "disabled"];
const _hoisted_86 = { class: "sr-only" };
const _hoisted_87 = ["onClick", "disabled"];
const _hoisted_88 = ["onClick", "disabled"];
const _hoisted_89 = { class: "sr-only" };
const _hoisted_90 = {
  key: 0,
  class: "topic-accordion-content py-2"
};
const _hoisted_91 = { class: "divide-y divide-gray-200 dark:divide-gray-700" };
const _hoisted_92 = {
  key: 1,
  class: "divide-y divide-gray-200 dark:divide-gray-700"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["play-audio", "edit-word", "delete-word", "toggle-favorite", "view-details", "date-group-previous", "date-group-next", "accordion-toggle", "note-saved", "open-note-dialog", "open-add-vocabulary-dialog", "open-grammar-manager", "move-vocabulary", "request-available-dates", "batch-move-category"],
  setup(__props, { emit: __emit }) {
    const { t, locale } = useI18n();
    const VocabularyCard = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./VocabularyCard-Dxtzsuhx.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0))
    );
    const VocabularyNoteButton = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./VocabularyNoteButton-Cj1fi7xp.js"), true ? __vite__mapDeps([7,1]) : void 0))
    );
    const GrammarManagerButton = defineAsyncComponent(() => loadComponentSafely(() => __vitePreload(() => import("./GrammarManagerButton-BlalyMdu.js"), true ? __vite__mapDeps([8,1]) : void 0))());
    const props = __props;
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("label", _hoisted_8, [
                    ...
                    _cache[49] || (_cache[49] = createBaseVNode("div", { class: "w-9 h-5 sm:w-11 sm:h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-1 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 sm:after:h-5 sm:after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600" }, null, -1))
                  ])
                ]),
                ...
                showTopicInput.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
                  ...
                  groupTopic.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
                    createBaseVNode("div", _hoisted_19, [
                      _cache[54] || (_cache[54] = createBaseVNode("svg", {
                      ...
                      createBaseVNode("div", _hoisted_20, [
                        ...
                        showTopicTooltip.value && isTopicTruncated.value ? (openBlock(), createElementBlock("div", _hoisted_21, [
                          ...
                          _cache[52] || (_cache[52] = createBaseVNode("div", { class: "absolute top-full left-1/2 transform -translate-x-1/2 border-4 border-transparent border-t-gray-900 dark:border-t-gray-700" }, null, -1))
                        ])) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("button", {
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("label", _hoisted_35, [
                    ...
                    _cache[59] || (_cache[59] = createBaseVNode("div", { class: "w-7 h-4 bg-gray-200 peer-focus:outline-none peer-focus:ring-1 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600" }, null, -1))
                  ])
                ]),
                createBaseVNode("div", _hoisted_36, [
                  ...
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("label", _hoisted_40, [
                      ...
                      _cache[60] || (_cache[60] = createBaseVNode("div", { class: "w-9 h-5 sm:w-11 sm:h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 sm:after:h-5 sm:after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600" }, null, -1))
                    ]),
              ...
              createBaseVNode("div", {
                ...
                !showTopicInput.value ? (openBlock(), createElementBlock("div", _hoisted_45, [
                  groupTopic.value ? (openBlock(), createElementBlock("div", _hoisted_46, [
                    _cache[63] || (_cache[63] = createBaseVNode("svg", {
                    ...
                    createBaseVNode("div", _hoisted_47, [
                      ...
                      showTopicTooltip.value && isTopicTruncated.value ? (openBlock(), createElementBlock("div", _hoisted_48, [
                        createTextVNode(toDisplayString(groupTopic.value) + " ", 1),
                        _cache[61] || (_cache[61] = createBaseVNode("div", { class: "absolute top-full left-1/2 transform -translate-x-1/2 border-4 border-transparent border-t-gray-900 dark:border-t-gray-700" }, null, -1))
                      ])) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("button", {
                      onClick: withModifiers(editTopic, ["stop"]),
                    ...
                    groupTopic.value ? (openBlock(), createElementBlock("div", _hoisted_60, [
                      ...
                      createBaseVNode("div", _hoisted_61, [
                        ...
                        showTopicTooltip.value && isTopicTruncated.value ? (openBlock(), createElementBlock("div", _hoisted_62, [
                          createTextVNode(toDisplayString(groupTopic.value) + " ", 1),
                          _cache[68] || (_cache[68] = createBaseVNode("div", { class: "absolute top-full left-1/2 transform -translate-x-1/2 border-4 border-transparent border-t-gray-900 dark:border-t-gray-700" }, null, -1))
                        ])) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("button", {
                        onClick: withModifiers(editTopic, ["stop"]),
                ...
                _ctx.group.topics && _ctx.group.topics.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_70, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.group.topics, (topicGroup) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_72, [
                        createBaseVNode("div", {
                          ...
                          createBaseVNode("div", _hoisted_74, [
                            ...
                            createBaseVNode("h5", _hoisted_75, [
                              createTextVNode(toDisplayString(unref(getTopicName)(topicGroup.topic)) + " ", 1),
                              createBaseVNode("span", _hoisted_76, "(" + toDisplayString(topicGroup.vocabularies.length) + ")", 1)
                            ])
                          ]),
                          ...
                          ]), 8, _hoisted_77)) : createCommentVNode("", true)
                        ], 8, _hoisted_73),
                        isTopicExpanded(topicGroup.topic) && getPaginatedTopicVocabularies(topicGroup).totalPages > 1 ? (openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_78, [
                            createBaseVNode("div", _hoisted_79, [
                              ...
                              }, toDisplayString(unref(t)("common.previous")), 9, _hoisted_80),
                              createBaseVNode("button", {
                                onClick: ($event) => nextTopicPage(topicGroup.topic),
                                disabled: !getPaginatedTopicVocabularies(topicGroup).hasNext,
                                class: "ml-2 relative inline-flex items-center px-2 md:px-2 py-1 md:py-1.5 xl:py-1.5 2xl:py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium rounded text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0a0a0a] hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                              }, toDisplayString(unref(t)("common.next")), 9, _hoisted_81)
                            ]),
                            createBaseVNode("div", _hoisted_82, [
                              createBaseVNode("div", null, [
                                createBaseVNode("p", _hoisted_83, toDisplayString(unref(t)("vocabulary.showingCategoryItems", {
                              ...
                              createBaseVNode("div", null, [
                                createBaseVNode("nav", _hoisted_84, [
                                  createBaseVNode("button", {
                                    onClick: ($event) => previousTopicPage(topicGroup.topic),
                                    disabled: !getPaginatedTopicVocabularies(topicGroup).hasPrevious,
                                    ...
                                    createBaseVNode("span", _hoisted_86, toDisplayString(unref(t)("common.previous")), 1),
                                    _cache[77] || (_cache[77] = createBaseVNode("svg", {
                                      class: "h-3 w-3",
                                      fill: "currentColor",
                                      viewBox: "0 0 20 20"
                                    }, [
                                  ...
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(getVisibleTopicPages(getPaginatedTopicVocabularies(topicGroup).currentPage, getPaginatedTopicVocabularies(topicGroup).totalPages), (page) => {
                                    ...
                                    }, toDisplayString(page === -1 ? "..." : page), 11, _hoisted_87);
                                  }), 128)),
                                  createBaseVNode("button", {
                                    onClick: ($event) => nextTopicPage(topicGroup.topic),
                                    disabled: !getPaginatedTopicVocabularies(topicGroup).hasNext,
                                    ...
                                    createBaseVNode("span", _hoisted_89, toDisplayString(unref(t)("common.next")), 1),
                                    _cache[78] || (_cache[78] = createBaseVNode("svg", {
                                      class: "h-3 w-3",
                                      fill: "currentColor",
                                      viewBox: "0 0 20 20"
                                    }, [
                      ...
                      createVNode(Transition, { name: "topic-accordion" }, {
                        default: withCtx(() => [
                          isTopicExpanded(topicGroup.topic) ? (openBlock(), createElementBlock("div", _hoisted_90, [
                            createBaseVNode("div", _hoisted_91, [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(getPaginatedTopicVocabularies(topicGroup).vocabularies, (word) => {
                                return openBlock(), createBlock(unref(VocabularyCard), {
                                  ...
                                  onPlayAudio: _cache[37] || (_cache[37] = ($event) => _ctx.$emit("play-audio", $event)),
                                  onEditWord: _cache[38] || (_cache[38] = ($event) => _ctx.$emit("edit-word", $event)),
                                  onDeleteWord: _cache[39] || (_cache[39] = ($event) => _ctx.$emit("delete-word", $event)),
                                  onToggleFavorite: _cache[40] || (_cache[40] = ($event) => _ctx.$emit("toggle-favorite", $event)),
                                  onViewDetails: _cache[41] || (_cache[41] = ($event) => _ctx.$emit("view-details", $event)),
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.group.vocabularies, (word) => {
                    return openBlock(), createBlock(unref(VocabularyCard), {
                      ...
                      word,
                      "move-mode": _ctx.globalMoveMode,
                      onPlayAudio: _cache[42] || (_cache[42] = ($event) => _ctx.$emit("play-audio", $event)),
                      onEditWord: _cache[43] || (_cache[43] = ($event) => _ctx.$emit("edit-word", $event)),
                      onDeleteWord: _cache[44] || (_cache[44] = ($event) => _ctx.$emit("delete-word", $event)),
                      onToggleFavorite: _cache[45] || (_cache[45] = ($event) => _ctx.$emit("toggle-favorite", $event)),
                      onViewDetails: _cache[46] || (_cache[46] = ($event) => _ctx.$emit("view-details", $event)),
                      onMoveVocabulary: handleMoveVocabulary
                    }, null, 8, ["word", "move-mode"]);
                  }), 128))
                ]))
...
const DateGroupAccordion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-13e6bbba"]]);
export {
  DateGroupAccordion as default
};
//# sourceMappingURL=DateGroupAccordion-D5Eb9Nfi.js.map
