const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/VocabularyCard-ClUhnaAN.js","assets/vendor-vEVloz7Q.js","assets/index-D-rjLU_m.js","assets/vendor-toast-DqDt6EZQ.js","assets/vendor-toast-jG2HNJHr.css","assets/index-QWkG18kn.css","assets/VocabularyCard-Cw2LB8Qy.css","assets/DateGroupAccordion-wKrj0Vsn.js","assets/DateGroupAccordion-ClFvPcaT.css"])))=>i.map(i=>d[i]);
import { g as getTopicName, b as groupVocabulariesByDateAndTopic, l as loadComponentSafely, _ as __vitePreload } from "./index-D-rjLU_m.js";
import { u as useToast } from "./vendor-toast-DqDt6EZQ.js";
import { d as defineComponent, H as useI18n, A as ref, I as onMounted, B as computed, c as createElementBlock, v as openBlock, f as createBaseVNode, e as createCommentVNode, t as toDisplayString, u as unref, F as Fragment, j as renderList, g as createTextVNode, b as createBlock, D as defineAsyncComponent, n as normalizeClass, q as nextTick } from "./vendor-vEVloz7Q.js";
...
const _hoisted_4 = {
  class: "relative group/mi-tooltip ml-2 select-none",
  "aria-hidden": "false"
};
...
const _hoisted_7 = { class: "text-sm font-semibold mb-2" };
const _hoisted_8 = {
  key: 0,
...
const _hoisted_10 = { class: "text-xs font-medium text-gray-700 mb-1 dark:text-white/80" };
const _hoisted_11 = { class: "font-semibold" };
const _hoisted_12 = { class: "text-xs list-disc pl-4 space-y-0.5" };
...
const _hoisted_17 = { class: "flex-1 flex justify-between sm:hidden" };
const _hoisted_18 = ["disabled"];
const _hoisted_19 = ["disabled"];
const _hoisted_20 = { class: "hidden sm:flex-1 sm:flex sm:items-center sm:justify-between" };
const _hoisted_21 = { class: "text-sm text-gray-700 dark:text-gray-300" };
const _hoisted_22 = { class: "relative z-0 inline-flex rounded-md shadow-sm -space-x-px" };
...
const _hoisted_31 = { class: "flex-1 flex justify-between sm:hidden" };
const _hoisted_32 = ["disabled"];
const _hoisted_33 = ["disabled"];
const _hoisted_34 = { class: "hidden sm:flex-1 sm:flex sm:items-center sm:justify-between" };
const _hoisted_35 = { class: "text-sm text-gray-700 dark:text-gray-300" };
const _hoisted_36 = { class: "relative z-0 inline-flex rounded-md shadow-sm -space-x-px" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const DateGroupAccordion = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./DateGroupAccordion-wKrj0Vsn.js"), true ? __vite__mapDeps([7,2,1,3,4,5,8]) : void 0))
    );
    ...
    const missingImagesByDate = computed(() => {
      ...
      for (const w of source) {
        ...
        const displayCat = w.categoryName || getTopicName(catKey, w);
    ...
    const groupedWords = computed(() => {
      ...
      let allGroups = groupVocabulariesByDateAndTopic(wordsToGroup, locale.value);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_2, [
            ...
            createBaseVNode("div", _hoisted_4, [
              ...
              createBaseVNode("div", _hoisted_6, [
                createBaseVNode("div", _hoisted_7, toDisplayString(unref(t)("vocabulary.imageInfo.title", "Missing images by date")), 1),
                missingImagesByDate.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_8, toDisplayString(unref(t)("vocabulary.imageInfo.none", "All categories have images for the current list")), 1)) : (openBlock(), createElementBlock("div", _hoisted_9, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(missingImagesByDate.value, (item) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_10, [
                        ...
                        createBaseVNode("span", _hoisted_11, toDisplayString(item.date), 1)
                      ]),
                      createBaseVNode("ul", _hoisted_12, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(item.categories, (cat) => {
                          return openBlock(), createElementBlock("li", {
                            ...
                            createBaseVNode("span", null, toDisplayString(cat.name) + " — " + toDisplayString(unref(t)("vocabulary.imageInfo.missingCount", { count: cat.count }) || `${cat.count} without image`), 1)
                          ]);
                        }), 128))
                      ])
                    ]);
        ...
        _ctx.useGrouping && groupedWords.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_14, [
          ...
          dateGroupPaginationInfo.value.totalPages > 1 ? (openBlock(), createElementBlock("div", _hoisted_15, [
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", _hoisted_17, [
                ...
                }, toDisplayString(unref(t)("common.previous", "Previous")), 9, _hoisted_18),
                createBaseVNode("button", {
                ...
                }, toDisplayString(unref(t)("common.next", "Next")), 9, _hoisted_19)
              ]),
              createBaseVNode("div", _hoisted_20, [
                createBaseVNode("div", null, [
                  createBaseVNode("p", _hoisted_21, toDisplayString(unref(t)("vocabulary.showingDateGroups", {
                ...
                createBaseVNode("div", null, [
                  createBaseVNode("nav", _hoisted_22, [
                    createBaseVNode("button", {
                      ...
                      createBaseVNode("span", _hoisted_24, toDisplayString(unref(t)("common.previous", "Previous")), 1),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(visibleDateGroupPages.value, (page) => {
                      ...
                      }, toDisplayString(page === -1 ? "..." : page), 11, _hoisted_25);
                    }), 128)),
                    createBaseVNode("button", {
                      onClick: nextDateGroupPage,
                      disabled: !dateGroupPaginationInfo.value.hasNext,
                      ...
                      createBaseVNode("span", _hoisted_27, toDisplayString(unref(t)("common.next", "Next")), 1),
        ...
        !_ctx.useGrouping ? (openBlock(), createElementBlock("div", _hoisted_29, [
          createBaseVNode("div", _hoisted_30, [
            createBaseVNode("div", _hoisted_31, [
              ...
              }, toDisplayString(unref(t)("common.previous", "Previous")), 9, _hoisted_32),
              createBaseVNode("button", {
              ...
              }, toDisplayString(unref(t)("common.next", "Next")), 9, _hoisted_33)
            ]),
            createBaseVNode("div", _hoisted_34, [
              createBaseVNode("div", null, [
                createBaseVNode("p", _hoisted_35, toDisplayString(unref(t)("vocabulary.showingResults", { start: _ctx.startIndex, end: _ctx.endIndex, total: _ctx.totalCount }, `Showing ${_ctx.startIndex} to ${_ctx.endIndex} of ${_ctx.totalCount} results`)), 1)
              ]),
              createBaseVNode("div", null, [
                createBaseVNode("nav", _hoisted_36, [
                  createBaseVNode("button", {
                    ...
                    createBaseVNode("span", _hoisted_38, toDisplayString(unref(t)("common.previous", "Previous")), 1),
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.visiblePages, (page) => {
                    ...
                    }, toDisplayString(page), 11, _hoisted_39);
                  }), 128)),
                  createBaseVNode("button", {
                    ...
                    createBaseVNode("span", _hoisted_41, toDisplayString(unref(t)("common.next", "Next")), 1),
...
//# sourceMappingURL=VocabularyList-Jee9lnx7.js.map
