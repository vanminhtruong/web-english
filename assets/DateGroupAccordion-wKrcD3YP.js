const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/VocabularyCard-DMAqpdOP.js","assets/vendor-DMqe9Z5T.js","assets/index-YgTbBT2B.js","assets/vendor-toast-C02QcIAu.js","assets/vendor-toast-jG2HNJHr.css","assets/index-CNMDS1BC.css","assets/VocabularyCard-BJpZ1tLY.css","assets/VocabularyNoteButton-BMRnaJSL.js","assets/GrammarManagerButton-tfhF128L.js","assets/CircularProgress-BZLRXaPm.js","assets/CircularProgress-DGFYHuZs.css"])))=>i.map(i=>d[i]);
import { n as useFlashcardHistory, f as getDateKey, g as getTopicName, l as loadComponentSafely, _ as __vitePreload, a as _export_sfc } from "./index-YgTbBT2B.js";
import { d as defineComponent, H as useI18n, B as computed, A as ref, K as watch, I as onMounted, q as nextTick, L as onUnmounted, c as createElementBlock, v as openBlock, f as createBaseVNode, y as createVNode, e as createCommentVNode, n as normalizeClass, t as toDisplayString, u as unref, D as defineAsyncComponent, i as withModifiers, C as withDirectives, N as vModelCheckbox, S as vModelText, Z as withKeys, g as createTextVNode, F as Fragment, w as withCtx, j as renderList, M as Transition, b as createBlock } from "./vendor-DMqe9Z5T.js";
...
const _hoisted_8 = { class: "inline-flex items-center ml-1.5 xs:ml-2" };
const _hoisted_9 = { class: "relative inline-flex items-center cursor-pointer" };
const _hoisted_10 = ["disabled"];
const _hoisted_11 = { class: "text-xs sm:text-sm md:text-base lg:text-lg xl:text-base 2xl:text-lg text-gray-500 dark:text-gray-400" };
const _hoisted_12 = ["disabled"];
const _hoisted_13 = {
  key: 0,
  class: "flex items-center justify-center mb-3"
};
const _hoisted_14 = { class: "flex items-center space-x-1 w-full max-w-[280px]" };
...
const _hoisted_20 = { class: "flex items-center space-x-1 px-2.5 py-1 bg-orange-50 dark:bg-orange-900/50 rounded-lg border border-orange-200 dark:border-orange-700 max-w-[180px]" };
const _hoisted_21 = { class: "relative flex-1 min-w-0" };
const _hoisted_22 = {
  key: 0,
...
const _hoisted_24 = { class: "grid grid-cols-2 gap-2 max-w-[280px] sm:max-w-[320px] mx-auto" };
const _hoisted_25 = ["aria-label"];
const _hoisted_26 = { class: "text-center leading-tight" };
const _hoisted_27 = {
  key: 1,
  class: "flex"
};
const _hoisted_28 = ["aria-label"];
const _hoisted_29 = { class: "text-center leading-tight" };
const _hoisted_30 = {
  key: 3,
  class: "flex"
};
const _hoisted_31 = { class: "hidden md:block" };
const _hoisted_32 = { class: "flex items-center space-x-2" };
const _hoisted_33 = { class: "p-1 rounded-md" };
const _hoisted_34 = { class: "text-xs xs:text-sm sm:text-sm md:text-base lg:text-base xl:text-sm 2xl:text-base font-semibold text-gray-700 dark:text-gray-300 flex items-center space-x-1 xs:space-x-1.5 sm:space-x-2" };
const _hoisted_35 = { class: "text-xs xs:text-xs sm:text-sm md:text-sm lg:text-base xl:text-sm 2xl:text-base text-gray-500 dark:text-gray-400" };
const _hoisted_36 = { class: "inline-flex items-center ml-1.5 xs:ml-2" };
const _hoisted_37 = { class: "relative inline-flex items-center cursor-pointer" };
const _hoisted_38 = { class: "hidden lg:flex items-center space-x-2" };
const _hoisted_39 = ["disabled"];
const _hoisted_40 = { class: "text-xs sm:text-sm md:text-base lg:text-lg xl:text-sm 2xl:text-base text-gray-500 dark:text-gray-400" };
const _hoisted_41 = ["disabled"];
const _hoisted_42 = { class: "relative inline-flex items-center cursor-pointer" };
const _hoisted_43 = { class: "text-xs sm:text-sm md:text-base lg:text-lg xl:text-sm 2xl:text-base text-gray-600 dark:text-gray-300" };
const _hoisted_44 = ["disabled"];
const _hoisted_45 = { class: "text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400" };
...
const _hoisted_49 = { class: "relative" };
const _hoisted_50 = {
  key: 0,
  class: "absolute z-[9999] bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg whitespace-nowrap"
};
...
const _hoisted_58 = ["aria-label"];
const _hoisted_59 = { class: "hidden lg:block" };
const _hoisted_60 = { class: "flex-1 flex justify-center mx-1 xs:mx-2 sm:mx-4 min-w-0" };
const _hoisted_61 = {
  key: 0,
...
const _hoisted_73 = ["onMouseenter", "onMouseleave"];
const _hoisted_74 = { class: "bg-gray-50 dark:bg-gray-custom border-b border-gray-200 dark:border-gray-700" };
const _hoisted_75 = ["id", "onClick"];
const _hoisted_76 = { class: "flex items-center space-x-2" };
const _hoisted_77 = { class: "flex items-center space-x-1" };
const _hoisted_78 = { class: "text-sm font-medium text-gray-600 dark:text-gray-400" };
const _hoisted_79 = { class: "text-xs text-gray-500" };
const _hoisted_80 = ["onMouseenter"];
const _hoisted_81 = ["aria-label"];
const _hoisted_82 = { class: "text-xs font-semibold mb-2" };
const _hoisted_83 = {
  key: 0,
  class: "text-xs text-gray-600 dark:text-white/70"
};
const _hoisted_84 = ["onClick"];
const _hoisted_85 = { class: "text-gray-500 dark:text-white/60" };
const _hoisted_86 = ["onClick", "title"];
const _hoisted_87 = { class: "flex items-center justify-between text-xs" };
const _hoisted_88 = { class: "flex-1 flex justify-between sm:hidden" };
const _hoisted_89 = ["onClick", "disabled"];
const _hoisted_90 = ["onClick", "disabled"];
const _hoisted_91 = { class: "hidden sm:flex-1 sm:flex sm:items-center sm:justify-between" };
const _hoisted_92 = { class: "text-xs text-gray-700 dark:text-gray-300" };
const _hoisted_93 = { class: "relative z-0 inline-flex rounded-md shadow-sm -space-x-px" };
const _hoisted_94 = ["onClick", "disabled"];
const _hoisted_95 = { class: "sr-only" };
const _hoisted_96 = ["onClick", "disabled"];
...
const _hoisted_100 = { class: "divide-y divide-gray-200 dark:divide-gray-700" };
const _hoisted_101 = {
  key: 1,
  class: "divide-y divide-gray-200 dark:divide-gray-700"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const VocabularyCard = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./VocabularyCard-DMAqpdOP.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0))
    );
    ...
    const CircularProgress = defineAsyncComponent(
      loadComponentSafely(() => __vitePreload(() => import("./CircularProgress-BZLRXaPm.js"), true ? __vite__mapDeps([9,1,2,3,4,5,10]) : void 0))
    );
    const props = __props;
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              createBaseVNode("div", {
                ...
                isExpanded.value && _ctx.group.totalPages && _ctx.group.totalPages > 1 ? (openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_11, toDisplayString(_ctx.group.currentPage || 1) + "/" + toDisplayString(_ctx.group.totalPages), 1),
                  createBaseVNode("button", {
              ...
              createBaseVNode("div", {
                ...
                showTopicInput.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
                  ...
                  groupTopic.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
                    createBaseVNode("div", _hoisted_20, [
                      ...
                      createBaseVNode("div", _hoisted_21, [
                        ...
                        showTopicTooltip.value && isTopicTruncated.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
                  ...
                  createBaseVNode("div", _hoisted_24, [
                    !groupTopic.value ? (openBlock(), createElementBlock("button", {
                      ...
                      createBaseVNode("span", _hoisted_26, toDisplayString(unref(t)("vocabulary.accordion.addTopic", "Add Topic")), 1)
                    ], 8, _hoisted_25)) : createCommentVNode("", true),
                    showActionButtons.value ? (openBlock(), createElementBlock("div", _hoisted_27, [
                    ...
                    showActionButtons.value ? (openBlock(), createElementBlock("button", {
                      ...
                      createBaseVNode("span", _hoisted_29, toDisplayString(unref(t)("vocabulary.addWord", "Add Word")), 1)
                    ], 8, _hoisted_28)) : createCommentVNode("", true),
                    showActionButtons.value ? (openBlock(), createElementBlock("div", _hoisted_30, [
            ...
            createBaseVNode("div", _hoisted_31, [
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_32, [
                  ...
                  createBaseVNode("h4", _hoisted_34, [
                    ...
                    createBaseVNode("span", null, toDisplayString(_ctx.group.displayDate), 1),
                    createBaseVNode("span", _hoisted_35, " (" + toDisplayString(totalVocabularyCount.value) + " " + toDisplayString(unref(t)("vocabulary.words", "words")) + ") ", 1),
                ...
                createBaseVNode("div", _hoisted_38, [
                  isExpanded.value && _ctx.group.totalPages && _ctx.group.totalPages > 1 ? (openBlock(), createElementBlock("div", {
                    ...
                    }, toDisplayString(unref(t)("common.previous")), 9, _hoisted_39),
                    createBaseVNode("span", _hoisted_40, toDisplayString(_ctx.group.currentPage || 1) + " / " + toDisplayString(_ctx.group.totalPages), 1),
                    createBaseVNode("button", {
                      onClick: _cache[14] || (_cache[14] = ($event) => _ctx.$emit("date-group-next", _ctx.group.date)),
                      disabled: (_ctx.group.currentPage || 1) === _ctx.group.totalPages,
                      class: "px-2 md:px-2 py-1 md:py-1.5 xl:py-1.5 2xl:py-1.5 xl:px-3 xl:py-1.5 2xl:px-4 2xl:py-2 text-xs xs:text-xs sm:text-sm md:text-sm lg:text-base xl:text-sm 2xl:text-base border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-[#0a0a0a] text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                    }, toDisplayString(unref(t)("common.next")), 9, _hoisted_41)
                  ])) : createCommentVNode("", true),
                  createBaseVNode("div", {
                    class: "flex items-center space-x-2",
                    ...
                    createBaseVNode("span", _hoisted_43, toDisplayString(unref(t)("common.actions", "Actions")), 1)
                  ])
                ])
              ]),
              isExpanded.value && _ctx.group.totalPages && _ctx.group.totalPages > 1 ? (openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_45, toDisplayString(_ctx.group.currentPage || 1) + "/" + toDisplayString(_ctx.group.totalPages), 1),
                createBaseVNode("button", {
              ...
              createBaseVNode("div", {
                ...
                !showTopicInput.value ? (openBlock(), createElementBlock("div", _hoisted_47, [
                  groupTopic.value ? (openBlock(), createElementBlock("div", _hoisted_48, [
                    ...
                    createBaseVNode("div", _hoisted_49, [
                      ...
                      showTopicTooltip.value && isTopicTruncated.value ? (openBlock(), createElementBlock("div", _hoisted_50, [
                        createTextVNode(toDisplayString(groupTopic.value) + " ", 1),
                    ...
                    createBaseVNode("span", _hoisted_53, toDisplayString(unref(t)("vocabulary.accordion.addTopic", "Add Topic")), 1)
                  ], 8, _hoisted_52)),
            ...
            createBaseVNode("div", _hoisted_59, [
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_60, [
                  !showTopicInput.value ? (openBlock(), createElementBlock("div", _hoisted_61, [
                    groupTopic.value ? (openBlock(), createElementBlock("div", _hoisted_62, [
                      ...
                      createBaseVNode("div", _hoisted_63, [
                        ...
                        showTopicTooltip.value && isTopicTruncated.value ? (openBlock(), createElementBlock("div", _hoisted_64, [
                          createTextVNode(toDisplayString(groupTopic.value) + " ", 1),
          ...
          createVNode(Transition, { name: "accordion" }, {
            default: withCtx(() => [
              isExpanded.value ? (openBlock(), createElementBlock("div", _hoisted_71, [
                _ctx.group.topics && _ctx.group.topics.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_72, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.group.topics, (topicGroup) => {
                    return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("div", {
                          ...
                          createBaseVNode("div", _hoisted_76, [
                            ...
                            createBaseVNode("div", _hoisted_77, [
                              createBaseVNode("h5", _hoisted_78, [
                                createTextVNode(toDisplayString(unref(getTopicName)(topicGroup.topic)) + " ", 1),
                                createBaseVNode("span", _hoisted_79, "(" + toDisplayString(topicGroup.vocabularies.length) + ")", 1)
                              ]),
                              createBaseVNode("div", {
                                class: "relative",
                                ...
                                infoHoverTopic.value === topicGroup.topic ? (openBlock(), createElementBlock("div", {
                                  ...
                                  createBaseVNode("div", _hoisted_82, toDisplayString(unref(t)("vocabulary.sameTopicDatesTitle", "Dates with same topic")), 1),
                                  !availableDatesByTopic.value[topicGroup.topic] || availableDatesByTopic.value[topicGroup.topic].length === 0 ? (openBlock(), createElementBlock("div", _hoisted_83, toDisplayString(unref(t)("vocabulary.sameTopicDatesEmpty", "No other dates found for this topic")), 1)) : (openBlock(), createElementBlock("ul", {
                                    key: 1,
                                    ...
                                    (openBlock(true), createElementBlock(Fragment, null, renderList(availableDatesByTopic.value[topicGroup.topic], (d) => {
                                      return openBlock(), createElementBlock("li", {
                                        ...
                                        createBaseVNode("span", _hoisted_85, "(" + toDisplayString(d.count) + ")", 1)
                                      ], 8, _hoisted_84);
                                    }), 128))
                                  ], 2))
                          ...
                          ]), 8, _hoisted_86)) : createCommentVNode("", true)
                        ], 8, _hoisted_75),
                        isTopicExpanded(topicGroup.topic) && getPaginatedTopicVocabularies(topicGroup).totalPages > 1 ? (openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_87, [
                            createBaseVNode("div", _hoisted_88, [
                              ...
                              }, toDisplayString(unref(t)("common.previous")), 9, _hoisted_89),
                              createBaseVNode("button", {
                                onClick: ($event) => nextTopicPage(topicGroup.topic),
                                disabled: !getPaginatedTopicVocabularies(topicGroup).hasNext,
                                class: "ml-2 relative inline-flex items-center px-2 md:px-2 py-1 md:py-1.5 xl:py-1.5 2xl:py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium rounded text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0a0a0a] hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                              }, toDisplayString(unref(t)("common.next")), 9, _hoisted_90)
                            ]),
                            createBaseVNode("div", _hoisted_91, [
                              createBaseVNode("div", null, [
                                createBaseVNode("p", _hoisted_92, toDisplayString(unref(t)("vocabulary.showingCategoryItems", {
                              ...
                              createBaseVNode("div", null, [
                                createBaseVNode("nav", _hoisted_93, [
                                  createBaseVNode("button", {
                                    onClick: ($event) => previousTopicPage(topicGroup.topic),
                                    disabled: !getPaginatedTopicVocabularies(topicGroup).hasPrevious,
                                    ...
                                    createBaseVNode("span", _hoisted_95, toDisplayString(unref(t)("common.previous")), 1),
                                  ...
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(getVisibleTopicPages(getPaginatedTopicVocabularies(topicGroup).currentPage, getPaginatedTopicVocabularies(topicGroup).totalPages), (page) => {
                                    ...
                                    }, toDisplayString(page === -1 ? "..." : page), 11, _hoisted_96);
                                  }), 128)),
                                  createBaseVNode("button", {
                                    onClick: ($event) => nextTopicPage(topicGroup.topic),
                                    disabled: !getPaginatedTopicVocabularies(topicGroup).hasNext,
                                    ...
                                    createBaseVNode("span", _hoisted_98, toDisplayString(unref(t)("common.next")), 1),
                      ...
                      createVNode(Transition, { name: "topic-accordion" }, {
                        default: withCtx(() => [
                          isTopicExpanded(topicGroup.topic) ? (openBlock(), createElementBlock("div", _hoisted_99, [
...
const DateGroupAccordion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3fb93ee5"]]);
export {
  DateGroupAccordion as default
};
//# sourceMappingURL=DateGroupAccordion-wKrcD3YP.js.map
