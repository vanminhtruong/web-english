const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FireworkSoundEffect-vfwkjyFc.js","assets/vendor-DoTKyHPB.js","assets/index-1w8025Ge.js","assets/vendor-toast-D1B2ty4j.js","assets/vendor-toast-jG2HNJHr.css","assets/index-C_IBzbaw.css","assets/FireworkSoundEffect-Z17vpFMM.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e as useVoiceStore, a as _export_sfc } from "./index-1w8025Ge.js";
...
const _hoisted_31 = ["aria-label", "title"];
const _hoisted_32 = { class: "flex flex-wrap gap-2 justify-center" };
const _hoisted_33 = ["onDragstart"];
const _hoisted_34 = {
  key: 0,
...
const _hoisted_38 = { class: "text-sm text-gray-600 dark:text-white/70" };
const _hoisted_39 = { class: "font-semibold text-gray-900 dark:text-white" };
const _hoisted_40 = { class: "text-xs text-gray-500 dark:text-white/60 mt-1 line-clamp-2" };
const _hoisted_41 = {
  key: 1,
  class: "text-center"
};
const _hoisted_42 = { class: "text-sm text-gray-600 dark:text-white/70 line-clamp-2" };
const _hoisted_43 = {
  key: 1,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const FireworkSoundEffect = defineAsyncComponent(() => __vitePreload(() => import("./FireworkSoundEffect-vfwkjyFc.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1, [
            ...
            dragMode.value && !_ctx.pictionaryAnswered ? (openBlock(), createElementBlock("div", _hoisted_28, [
              ...
              createBaseVNode("div", _hoisted_32, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(filteredLetterBank.value, (ch) => {
                  ...
                  }, toDisplayString(ch), 41, _hoisted_33);
                }), 128))
              ])
            ])) : createCommentVNode("", true),
          ...
          _ctx.pictionaryAnswered ? (openBlock(), createElementBlock("div", _hoisted_34, [
            createBaseVNode("div", {
              ...
              _ctx.pictionaryCorrect ? (openBlock(), createElementBlock("svg", _hoisted_35, _cache[10] || (_cache[10] = [
                createBaseVNode("path", {
                  "fill-rule": "evenodd",
                  d: "M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z",
                  "clip-rule": "evenodd"
                }, null, -1)
              ]))) : (openBlock(), createElementBlock("svg", _hoisted_36, _cache[11] || (_cache[11] = [
                createBaseVNode("path", {
                  "fill-rule": "evenodd",
            ...
            !_ctx.pictionaryCorrect ? (openBlock(), createElementBlock("div", _hoisted_37, [
              createBaseVNode("p", _hoisted_38, [
                createTextVNode(toDisplayString(unref(t)("flashcard.image.correctAnswer", "Correct answer")) + ": ", 1),
                createBaseVNode("span", _hoisted_39, toDisplayString(_ctx.card?.word), 1)
              ]),
              createBaseVNode("p", _hoisted_40, toDisplayString(_ctx.card?.meaning), 1)
            ])) : (openBlock(), createElementBlock("div", _hoisted_41, [
              createBaseVNode("p", _hoisted_42, toDisplayString(_ctx.card?.meaning), 1)
            ]))
          ])) : createCommentVNode("", true),
          !_ctx.pictionaryAnswered ? (openBlock(), createElementBlock("p", _hoisted_43, toDisplayString(props.definitionMode ? dragMode.value ? unref(t)("flashcard.pictionary.dragInstructionDefinition", "Look at the definition above, drag letters into the boxes, then press Enter to check.") : unref(t)("flashcard.pictionary.instructionDefinition", "Look at the definition above, click the boxes and type to fill in the missing letters. Press Enter to check.") : dragMode.value ? unref(t)("flashcard.pictionary.dragInstruction", "Drag letters into the boxes, then press Enter to check.") : unref(t)("flashcard.pictionary.instruction", "Click the boxes and type to fill in the missing letters. Press Enter to check.")), 1)) : createCommentVNode("", true),
...
const PictionaryMode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2711c6da"]]);
export {
  PictionaryMode as default
};
//# sourceMappingURL=PictionaryMode-DV2-_ZzB.js.map
