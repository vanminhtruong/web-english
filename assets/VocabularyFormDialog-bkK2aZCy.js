const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ImageUpload-DKIRvyoI.js","assets/vendor-DoTKyHPB.js","assets/TopicManager-hrQMnoOm.js","assets/index-CBlo0dsz.js","assets/vendor-toast-D1B2ty4j.js","assets/vendor-toast-jG2HNJHr.css","assets/index-CU-nyeMQ.css","assets/TopicManager-SGNt9NVM.css"])))=>i.map(i=>d[i]);
import { c as useVocabularyStore, g as getTopicName, _ as __vitePreload, a as _export_sfc } from "./index-CBlo0dsz.js";
import { d as defineComponent, H as useI18n, A as ref, B as computed, a1 as reactive, I as onMounted, q as nextTick, L as onUnmounted, K as watch, c as createElementBlock, v as openBlock, y as createVNode, b as createBlock, e as createCommentVNode, w as withCtx, M as Transition, f as createBaseVNode, i as withModifiers, t as toDisplayString, u as unref, C as withDirectives, g as createTextVNode, S as vModelText, O as vModelSelect, n as normalizeClass, a0 as Teleport, a as normalizeStyle, Z as withKeys, F as Fragment, j as renderList, D as defineAsyncComponent, N as vModelCheckbox } from "./vendor-DoTKyHPB.js";
...
const _hoisted_17 = { value: "noun" };
const _hoisted_18 = { value: "verb" };
const _hoisted_19 = { value: "adjective" };
const _hoisted_20 = { value: "adverb" };
const _hoisted_21 = { value: "preposition" };
const _hoisted_22 = { value: "conjunction" };
const _hoisted_23 = { value: "interjection" };
const _hoisted_24 = {
  class: "animate-fade-in-up",
...
const _hoisted_29 = ["placeholder", "value"];
...
const _hoisted_32 = { class: "max-h-40 overflow-y-auto" };
const _hoisted_33 = {
  key: 0,
...
const _hoisted_38 = { value: "beginner" };
const _hoisted_39 = { value: "intermediate" };
const _hoisted_40 = { value: "advanced" };
const _hoisted_41 = {
  class: "md:col-span-2 animate-fade-in-up",
...
const _hoisted_58 = { class: "flex items-center p-3 bg-gray-50 dark:bg-[#0a0a0a] rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300" };
const _hoisted_59 = {
  for: "favorite",
...
const _hoisted_60 = { class: "px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-[#0a0a0a] dark:to-[#0a0a0a]" };
const _hoisted_61 = { class: "flex justify-end space-x-3" };
...
const _hoisted_65 = { class: "w-full max-w-2xl" };
const _hoisted_66 = { class: "px-5 py-4 border-b border-gray-200 dark:border-dark-bg-mute bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-dark-bg-soft dark:to-dark-bg-soft flex items-center justify-between" };
const _hoisted_67 = { class: "text-lg font-semibold text-gray-900 dark:text-white flex items-center space-x-2" };
const _hoisted_68 = ["title", "aria-label"];
const _hoisted_69 = { class: "px-5 py-4 space-y-4" };
const _hoisted_70 = { class: "p-3 rounded-lg border border-gray-200 dark:border-dark-bg-mute bg-white dark:bg-gray-custom" };
const _hoisted_71 = { class: "text-2xl md:text-3xl font-mono text-gray-900 dark:text-white break-words min-h-[2.5rem]" };
const _hoisted_72 = { class: "flex flex-wrap gap-2" };
const _hoisted_73 = ["title", "aria-label"];
const _hoisted_74 = ["title", "aria-label"];
const _hoisted_75 = ["title", "aria-label"];
const _hoisted_76 = ["title", "aria-label"];
const _hoisted_77 = { class: "space-y-4" };
const _hoisted_78 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2" };
const _hoisted_79 = { class: "flex flex-wrap gap-2" };
const _hoisted_80 = ["onClick"];
const _hoisted_81 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2" };
const _hoisted_82 = { class: "flex flex-wrap gap-2" };
const _hoisted_83 = ["onClick"];
const _hoisted_84 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2" };
const _hoisted_85 = { class: "flex flex-wrap gap-2" };
const _hoisted_86 = ["onClick"];
const _hoisted_87 = { class: "text-sm font-medium text-gray-600 dark:text-white/70 mb-2" };
const _hoisted_88 = { class: "flex flex-wrap gap-2" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const ImageUpload = defineAsyncComponent(() => __vitePreload(() => import("./ImageUpload-DKIRvyoI.js"), true ? __vite__mapDeps([0,1]) : void 0));
    const TopicManager = defineAsyncComponent(() => __vitePreload(() => import("./TopicManager-hrQMnoOm.js"), true ? __vite__mapDeps([2,1,3,4,5,6,7]) : void 0));
    const props = __props;
    const emit = __emit;
    const { t } = useI18n();
    ...
    const IPA_CONSONANTS = [
      ...
      "j",
      "w",
      // Other commonly used in English transcriptions
      "ʔ",
      "ɾ",
      "ʍ"
    ];
    ...
    const openIpaPicker = () => {
      ipaDraft.value = form.pronunciation || "";
      showIpaPicker.value = true;
    };
    const closeIpaPicker = () => {
      showIpaPicker.value = false;
    };
    ...
    const applyIpa = () => {
      form.pronunciation = ipaDraft.value.trim();
      closeIpaPicker();
    };
      ...
      return openBlock(), createElementBlock("div", null, [
                      ...
                      createBaseVNode("div", _hoisted_3, [
                        createBaseVNode("div", _hoisted_4, [
                          createBaseVNode("h2", _hoisted_5, [
                            _cache[20] || (_cache[20] = createBaseVNode("span", { class: "w-2 h-2 bg-blue-500 rounded-full animate-pulse" }, null, -1)),
                          ...
                          createBaseVNode("div", _hoisted_6, [
                            createBaseVNode("div", _hoisted_7, [
                              createBaseVNode("label", _hoisted_8, [
                                _cache[22] || (_cache[22] = createBaseVNode("span", { class: "w-1 h-4 bg-blue-500 rounded mr-2" }, null, -1)),
                                createTextVNode(" " + toDisplayString(unref(t)("vocabulary.word", "Word")) + " ", 1),
                                _cache[23] || (_cache[23] = createBaseVNode("span", { class: "text-red-500 ml-1" }, "*", -1))
                              ]),
                            ...
                            createBaseVNode("div", _hoisted_10, [
                              createBaseVNode("label", _hoisted_11, [
                                _cache[24] || (_cache[24] = createBaseVNode("span", { class: "w-1 h-4 bg-green-500 rounded mr-2" }, null, -1)),
                                createTextVNode(" " + toDisplayString(unref(t)("vocabulary.pronunciation.label", "Pronunciation")), 1)
                              ]),
                              createBaseVNode("div", _hoisted_12, [
                                ...
                                createBaseVNode("button", {
                                  ...
                                  title: unref(t)("vocabulary.pronunciation.openIpaPicker", "Open IPA Picker"),
                                  "aria-label": unref(t)("vocabulary.pronunciation.openIpaPicker", "Open IPA Picker")
                                }, " + ", 8, _hoisted_13)
                              ])
                            ]),
                            createBaseVNode("div", _hoisted_14, [
                              createBaseVNode("label", _hoisted_15, [
                                _cache[25] || (_cache[25] = createBaseVNode("span", { class: "w-1 h-4 bg-purple-500 rounded mr-2" }, null, -1)),
                              ...
                              withDirectives(createBaseVNode("select", {
                                ...
                                createBaseVNode("option", _hoisted_16, toDisplayString(unref(t)("vocabulary.selectWordType", "Select word type")), 1),
                                createBaseVNode("option", _hoisted_17, toDisplayString(unref(t)("vocabulary.wordTypes.noun", "Noun")), 1),
                                createBaseVNode("option", _hoisted_18, toDisplayString(unref(t)("vocabulary.wordTypes.verb", "Verb")), 1),
                                createBaseVNode("option", _hoisted_19, toDisplayString(unref(t)("vocabulary.wordTypes.adjective", "Adjective")), 1),
                                createBaseVNode("option", _hoisted_20, toDisplayString(unref(t)("vocabulary.wordTypes.adverb", "Adverb")), 1),
                                createBaseVNode("option", _hoisted_21, toDisplayString(unref(t)("vocabulary.wordTypes.preposition", "Preposition")), 1),
                                createBaseVNode("option", _hoisted_22, toDisplayString(unref(t)("vocabulary.wordTypes.conjunction", "Conjunction")), 1),
                                createBaseVNode("option", _hoisted_23, toDisplayString(unref(t)("vocabulary.wordTypes.interjection", "Interjection")), 1)
                              ], 544), [
                            ...
                            createBaseVNode("div", _hoisted_24, [
                              createBaseVNode("label", _hoisted_25, [
                                _cache[27] || (_cache[27] = createBaseVNode("span", { class: "w-1 h-4 bg-orange-500 rounded mr-2" }, null, -1)),
                                createTextVNode(" " + toDisplayString(unref(t)("vocabulary.category", "Category")) + " ", 1),
                                _cache[28] || (_cache[28] = createBaseVNode("span", { class: "text-red-500 ml-1" }, "*", -1))
                              ]),
                                      ...
                                      default: withCtx(() => [
                                        showCategoryDropdown.value ? (openBlock(), createElementBlock("div", {
                                          ...
                                          createBaseVNode("div", _hoisted_32, [
                                            filteredCategoryKeys.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_33, toDisplayString(unref(t)("vocabulary.noCategories", "No categories found")), 1)) : createCommentVNode("", true),
                                            (openBlock(true), createElementBlock(Fragment, null, renderList(filteredCategoryKeys.value, (key) => {
                                              ...
                                              }, toDisplayString(getTopicDisplayName(key)), 11, _hoisted_34);
                                            }), 128))
                                          ])
                            ...
                            createBaseVNode("div", _hoisted_35, [
                              createBaseVNode("label", _hoisted_36, [
                                _cache[30] || (_cache[30] = createBaseVNode("span", { class: "w-1 h-4 bg-red-500 rounded mr-2" }, null, -1)),
                              ...
                              withDirectives(createBaseVNode("select", {
                                ...
                                createBaseVNode("option", _hoisted_37, toDisplayString(unref(t)("vocabulary.selectLevel", "Select level")), 1),
                                createBaseVNode("option", _hoisted_38, toDisplayString(unref(t)("vocabulary.levels.beginner", "Beginner")), 1),
                                createBaseVNode("option", _hoisted_39, toDisplayString(unref(t)("vocabulary.levels.intermediate", "Intermediate")), 1),
                                createBaseVNode("option", _hoisted_40, toDisplayString(unref(t)("vocabulary.levels.advanced", "Advanced")), 1)
                              ], 544), [
                            ...
                            createBaseVNode("div", _hoisted_41, [
                              createBaseVNode("label", _hoisted_42, [
                                _cache[32] || (_cache[32] = createBaseVNode("span", { class: "w-1 h-4 bg-indigo-500 rounded mr-2" }, null, -1)),
                                createTextVNode(" " + toDisplayString(unref(t)("vocabulary.meaning", "Meaning")) + " ", 1),
                                _cache[33] || (_cache[33] = createBaseVNode("span", { class: "text-red-500 ml-1" }, "*", -1))
                              ]),
                            ...
                            createBaseVNode("div", _hoisted_44, [
                              createBaseVNode("label", _hoisted_45, [
                                _cache[34] || (_cache[34] = createBaseVNode("span", { class: "w-1 h-4 bg-teal-500 rounded mr-2" }, null, -1)),
                            ...
                            createBaseVNode("div", _hoisted_47, [
                              createBaseVNode("label", _hoisted_48, [
                                _cache[35] || (_cache[35] = createBaseVNode("span", { class: "w-1 h-4 bg-pink-500 rounded mr-2" }, null, -1)),
                            ...
                            createBaseVNode("div", _hoisted_50, [
                              createBaseVNode("label", _hoisted_51, [
                                _cache[36] || (_cache[36] = createBaseVNode("span", { class: "w-1 h-4 bg-yellow-500 rounded mr-2" }, null, -1)),
                            ...
                            createBaseVNode("div", _hoisted_53, [
                              createBaseVNode("label", _hoisted_54, [
                                _cache[37] || (_cache[37] = createBaseVNode("span", { class: "w-1 h-4 bg-cyan-500 rounded mr-2" }, null, -1)),
                            ...
                            createBaseVNode("div", _hoisted_57, [
                              createBaseVNode("div", _hoisted_58, [
                                ...
                                createBaseVNode("label", _hoisted_59, toDisplayString(unref(t)("vocabulary.isFavorite", "Mark as favorite")), 1)
                              ])
                            ])
                          ])
                        ], 32)
                      ...
                      createBaseVNode("div", _hoisted_60, [
                        createBaseVNode("div", _hoisted_61, [
                          ...
                          createBaseVNode("button", {
                            ...
                            isSubmitting.value ? (openBlock(), createElementBlock("svg", _hoisted_63, _cache[38] || (_cache[38] = [
        ...
        (openBlock(), createBlock(Teleport, { to: "body" }, [
          createVNode(Transition, {
            ...
            default: withCtx(() => [
              showIpaPicker.value ? (openBlock(), createElementBlock("div", _hoisted_64, [
                createVNode(Transition, {
                  "enter-active-class": "transition-all duration-500 ease-out",
                  "enter-from-class": "opacity-0 scale-90 translate-y-8 rotate-1",
                  "enter-to-class": "opacity-100 scale-100 translate-y-0 rotate-0",
                      ...
                      createBaseVNode("div", {
                        ...
                        createBaseVNode("div", _hoisted_66, [
                          createBaseVNode("h3", _hoisted_67, [
                            _cache[39] || (_cache[39] = createBaseVNode("span", { class: "w-2 h-2 bg-blue-500 rounded-full animate-pulse" }, null, -1)),
                            createBaseVNode("span", null, toDisplayString(unref(t)("vocabulary.pronunciation.ipaPickerTitle", "IPA Picker")), 1)
                          ]),
                          createBaseVNode("button", {
                            type: "button",
                            onClick: closeIpaPicker,
                            class: "text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-all duration-300 hover:scale-110 hover:rotate-90 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800",
                        ...
                        createBaseVNode("div", _hoisted_69, [
                          createBaseVNode("div", _hoisted_70, [
                            createBaseVNode("div", _hoisted_71, toDisplayString(ipaDraft.value || unref(t)("vocabulary.pronunciation.previewPlaceholder", "Start building IPA...")), 1)
                          ]),
                          createBaseVNode("div", _hoisted_72, [
                            ...
                            }, toDisplayString(unref(t)("common.backspace", "Backspace")), 9, _hoisted_74),
                            createBaseVNode("button", {
                              type: "button",
                              onClick: clearIpa,
                              class: "px-3 py-1.5 rounded-lg border border-gray-300 dark:border-dark-bg-mute text-gray-800 dark:text-white dark:bg-gray-custom hover:bg-gray-100 dark:hover:bg-gray-custom",
                            ...
                            }, toDisplayString(unref(t)("common.clear", "Clear")), 9, _hoisted_75),
                            createBaseVNode("button", {
                              type: "button",
                              onClick: applyIpa,
                            ...
                            }, toDisplayString(unref(t)("common.apply", "Apply")), 9, _hoisted_76)
                          ]),
                          createBaseVNode("div", _hoisted_77, [
                            createBaseVNode("div", null, [
                              createBaseVNode("div", _hoisted_78, toDisplayString(unref(t)("vocabulary.pronunciation.vowels", "Vowels")), 1),
                              createBaseVNode("div", _hoisted_79, [
                                (openBlock(), createElementBlock(Fragment, null, renderList(IPA_VOWELS, (s) => {
                                  ...
                                  }, toDisplayString(s), 9, _hoisted_80);
                                }), 64))
                              ])
                            ]),
                            createBaseVNode("div", null, [
                              createBaseVNode("div", _hoisted_81, toDisplayString(unref(t)("vocabulary.pronunciation.diphthongs", "Diphthongs")), 1),
                              createBaseVNode("div", _hoisted_82, [
                                (openBlock(), createElementBlock(Fragment, null, renderList(IPA_DIPHTHONGS, (s) => {
                                  return createBaseVNode("button", {
                                    ...
                                    onClick: ($event) => appendIpa(s),
                                    class: "px-2.5 py-1.5 rounded-md border border-gray-300 dark:border-dark-bg-mute text-gray-900 dark:text-white dark:bg-gray-custom hover:bg-gray-100 dark:hover:bg-gray-custom"
                                  }, toDisplayString(s), 9, _hoisted_83);
                                }), 64))
                              ])
                            ]),
                            createBaseVNode("div", null, [
                              createBaseVNode("div", _hoisted_84, toDisplayString(unref(t)("vocabulary.pronunciation.consonants", "Consonants")), 1),
                              createBaseVNode("div", _hoisted_85, [
                                (openBlock(), createElementBlock(Fragment, null, renderList(IPA_CONSONANTS, (s) => {
                                  return createBaseVNode("button", {
                                    ...
                                    onClick: ($event) => appendIpa(s),
                                    class: "px-2.5 py-1.5 rounded-md border border-gray-300 dark:border-dark-bg-mute text-gray-900 dark:text-white dark:bg-gray-custom hover:bg-gray-100 dark:hover:bg-gray-custom"
                                  }, toDisplayString(s), 9, _hoisted_86);
                                }), 64))
                              ])
                            ]),
                            createBaseVNode("div", null, [
                              createBaseVNode("div", _hoisted_87, toDisplayString(unref(t)("vocabulary.pronunciation.marks", "Marks")), 1),
                              createBaseVNode("div", _hoisted_88, [
                                (openBlock(), createElementBlock(Fragment, null, renderList(IPA_MARKS, (s) => {
                                  return createBaseVNode("button", {
                                    ...
                                    onClick: ($event) => appendIpa(s),
                                    class: "px-2.5 py-1.5 rounded-md border border-gray-300 dark:border-dark-bg-mute text-gray-900 dark:text-white dark:bg-gray-custom hover:bg-gray-100 dark:hover:bg-gray-custom"
                                  }, toDisplayString(s === " " ? unref(t)("common.space", "Space") : s), 9, _hoisted_89);
                                }), 64))
                              ])
                            ])
                          ])
        ...
        showTopicManager.value ? (openBlock(), createBlock(unref(TopicManager), {
          ...
          "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => showTopicManager.value = $event),
...
const VocabularyFormDialog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6e0eb9b7"]]);
export {
  VocabularyFormDialog as default
};
//# sourceMappingURL=VocabularyFormDialog-bkK2aZCy.js.map
