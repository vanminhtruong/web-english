...
const _hoisted_17 = { class: "font-bold text-base" };
...
const _hoisted_22 = { class: "font-bold text-base" };
...
const _hoisted_25 = { class: "grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 gap-2" };
const _hoisted_26 = ["onClick"];
const _hoisted_27 = { class: "px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gray-50 dark:bg-[#0a0a0a]" };
const _hoisted_28 = { class: "flex justify-between items-center space-x-3" };
const _hoisted_29 = { class: "flex space-x-3" };
                            ...
                            createBaseVNode("div", _hoisted_15, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(koreanConsonants, (consonant) => {
                                return createBaseVNode("button", {
                                  ...
                                  createBaseVNode("span", _hoisted_17, toDisplayString(consonant.char), 1),
                                  createBaseVNode("span", _hoisted_18, toDisplayString(consonant.romanization), 1)
                                ], 8, _hoisted_16);
                              }), 64))
                            ])
                          ]),
                            ...
                            createBaseVNode("div", _hoisted_20, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(koreanVowels, (vowel) => {
                                return createBaseVNode("button", {
                                  ...
                                  createBaseVNode("span", _hoisted_22, toDisplayString(vowel.char), 1),
                                  createBaseVNode("span", _hoisted_23, toDisplayString(vowel.romanization), 1)
                                ], 8, _hoisted_21);
                              }), 64))
                            ])
                          ]),
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_25, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(commonKoreanSyllables, (syllable) => {
                                ...
                                }, toDisplayString(syllable), 9, _hoisted_26);
                              }), 64))
                            ])
                          ])
                        ])
...
const KoreanInputHelper = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8d93fe02"]]);
export {
  KoreanInputHelper as default
};
//# sourceMappingURL=KoreanInputHelper-CHZXd7sM.js.map
