...
const _hoisted_15 = { class: "grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2" };
const _hoisted_16 = ["onClick", "title"];
const _hoisted_17 = { class: "font-bold" };
const _hoisted_18 = { class: "text-xs text-gray-600 dark:text-gray-400" };
const _hoisted_19 = { class: "text-md font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center" };
const _hoisted_20 = { class: "grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2" };
const _hoisted_21 = ["onClick", "title"];
const _hoisted_22 = { class: "font-bold" };
const _hoisted_23 = { class: "text-xs text-gray-600 dark:text-gray-400" };
const _hoisted_24 = { class: "text-md font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center" };
const _hoisted_25 = { class: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2" };
...
const _hoisted_29 = { class: "text-md font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center" };
const _hoisted_30 = { class: "flex flex-wrap gap-2" };
const _hoisted_31 = ["onClick", "title"];
const _hoisted_32 = { class: "px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gray-50 dark:bg-[#0a0a0a]" };
const _hoisted_33 = { class: "flex justify-between items-center space-x-3" };
const _hoisted_34 = { class: "flex space-x-3" };
                      ...
                      createBaseVNode("div", _hoisted_3, [
                        createBaseVNode("div", _hoisted_4, [
                          createBaseVNode("h2", _hoisted_5, [
                            _cache[2] || (_cache[2] = createBaseVNode("span", { class: "w-2 h-2 bg-green-500 rounded-full animate-pulse" }, null, -1)),
                        ...
                        createBaseVNode("div", _hoisted_7, [
                          ...
                          createBaseVNode("div", _hoisted_9, [
                            withDirectives(createBaseVNode("input", {
                              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => currentPronunciation.value = $event),
                              type: "text",
                        ...
                        createBaseVNode("div", _hoisted_13, [
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_15, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(koreanConsonantSounds, (sound) => {
                                return createBaseVNode("button", {
                                  ...
                                  createBaseVNode("span", _hoisted_17, toDisplayString(sound.korean), 1),
                                  createBaseVNode("span", _hoisted_18, toDisplayString(sound.romanization), 1)
                                ], 8, _hoisted_16);
                              }), 64))
                            ])
                          ]),
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_20, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(koreanVowelSounds, (sound) => {
                                return createBaseVNode("button", {
                                  key: sound.korean,
                                  onClick: ($event) => addSound(sound.romanization),
                                  ...
                                  createBaseVNode("span", _hoisted_22, toDisplayString(sound.korean), 1),
                                  createBaseVNode("span", _hoisted_23, toDisplayString(sound.romanization), 1)
                                ], 8, _hoisted_21);
                              }), 64))
                            ])
                          ]),
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_25, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(commonKoreanPatterns, (pattern) => {
                                return createBaseVNode("button", {
                                  key: pattern.korean,
                                  ...
                                  createBaseVNode("span", _hoisted_27, toDisplayString(pattern.korean), 1),
                                  createBaseVNode("span", _hoisted_28, toDisplayString(pattern.romanization), 1)
                                ], 8, _hoisted_26);
                              }), 64))
                            ])
                          ]),
                          createBaseVNode("div", null, [
                            createBaseVNode("h3", _hoisted_29, [
                              _cache[8] || (_cache[8] = createBaseVNode("span", { class: "w-1 h-4 bg-yellow-500 rounded mr-2" }, null, -1)),
                            ...
                            createBaseVNode("div", _hoisted_30, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(specialChars, (char) => {
                                ...
                                }, toDisplayString(char.char), 9, _hoisted_31);
                              }), 64))
                            ])
                          ])
                        ])
...
const KoreanPronunciationHelper = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc6f3a43"]]);
export {
  KoreanPronunciationHelper as default
};
//# sourceMappingURL=KoreanPronunciationHelper-B0nyqsoH.js.map
