import { A as ref, d as defineComponent, H as useI18n, B as computed, K as watch, I as onMounted, q as nextTick, L as onUnmounted, c as createElementBlock, v as openBlock, f as createBaseVNode, t as toDisplayString, u as unref, e as createCommentVNode, y as createVNode, a as normalizeStyle, w as withCtx, M as Transition } from "./vendor-vEVloz7Q.js";
    ...
    const stopWordsWatch = watch(
      ...
      (newVal, oldVal) => {
        if (typeof oldVal === "number" && newVal > oldVal) {
          ...
          const last = game.stateManager.lastEatenWord?.value;
          if (last) {
...
const SnakeGameMode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-585ab1a6"]]);
export {
  SnakeGameMode as default
};
//# sourceMappingURL=SnakeGameMode-CZGEDu9u.js.map
