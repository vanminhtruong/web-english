...
const _hoisted_9 = { class: "p-4 bg-white dark:bg-dark-bg-mute border border-gray-200 dark:border-dark-bg-mute rounded-lg" };
const _hoisted_10 = { class: "text-2xl md:text-3xl font-mono text-gray-900 dark:text-white break-words min-h-[2.5rem] bg-gray-50 dark:bg-dark-bg-soft p-3 rounded border" };
...
const _hoisted_17 = { class: "space-y-6" };
const _hoisted_18 = { class: "text-md font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center" };
const _hoisted_19 = { class: "grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2" };
...
const _hoisted_23 = { class: "text-md font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center" };
const _hoisted_24 = { class: "grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2" };
...
const _hoisted_28 = { class: "text-md font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center" };
const _hoisted_29 = { class: "grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 gap-2" };
const _hoisted_30 = ["onClick"];
const _hoisted_31 = { class: "px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gray-50 dark:bg-[#0a0a0a]" };
const _hoisted_32 = { class: "flex justify-between items-center space-x-3" };
const _hoisted_33 = { class: "flex space-x-3" };
                    ...
                    createBaseVNode("div", {
                      ...
                      createBaseVNode("div", _hoisted_6, [
                        ...
                        createBaseVNode("div", _hoisted_9, [
                          createBaseVNode("div", _hoisted_10, toDisplayString(currentInput.value || unref(t)("vocabulary.pronunciation.previewPlaceholder", "Start typing Korean...")), 1)
                        ]),
                            ...
                            createBaseVNode("div", _hoisted_19, [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredConsonants.value, (consonant) => {
                                return openBlock(), createElementBlock("button", {
                                  ...
                                  createBaseVNode("span", _hoisted_21, toDisplayString(consonant.char), 1),
                                  createBaseVNode("span", _hoisted_22, toDisplayString(consonant.romanization), 1)
                                ], 8, _hoisted_20);
                              }), 128))
                            ])
                          ]),
                            ...
                            createBaseVNode("div", _hoisted_24, [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredVowels.value, (vowel) => {
                                return openBlock(), createElementBlock("button", {
                                  ...
                                  createBaseVNode("span", _hoisted_26, toDisplayString(vowel.char), 1),
                                  createBaseVNode("span", _hoisted_27, toDisplayString(vowel.romanization), 1)
                                ], 8, _hoisted_25);
                              }), 128))
                            ])
                          ]),
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_29, [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredCommonSyllables.value, (syllable) => {
                                ...
                                }, toDisplayString(syllable), 9, _hoisted_30);
                              }), 128))
                            ])
                          ])
                        ])
...
//# sourceMappingURL=KoreanInputHelper-CwKOSVFD.js.map
