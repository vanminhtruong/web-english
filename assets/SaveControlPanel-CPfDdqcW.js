import { d as defineComponent, H as useI18n, A as ref, K as watch, I as onMounted, B as computed, c as createElementBlock, v as openBlock, f as createBaseVNode, t as toDisplayString, u as unref, n as normalizeClass, e as createCommentVNode, g as createTextVNode } from "./vendor-DoTKyHPB.js";
...
const _hoisted_2 = { class: "bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-[#0f0f0f] dark:to-[#0a0a0a] px-6 py-4 border-b border-gray-200 dark:border-[#0f0f0f]" };
const _hoisted_3 = { class: "flex items-center justify-between" };
const _hoisted_4 = { class: "flex items-center space-x-3" };
const _hoisted_5 = { class: "text-lg font-semibold text-gray-900 dark:text-white" };
const _hoisted_6 = { class: "text-sm text-gray-500 dark:text-gray-400" };
...
const _hoisted_9 = { class: "text-sm font-medium text-gray-600 dark:text-gray-400" };
const _hoisted_10 = { class: "p-6" };
const _hoisted_11 = { class: "grid grid-cols-1 lg:grid-cols-3 gap-6" };
const _hoisted_12 = { class: "lg:col-span-2 space-y-4" };
const _hoisted_13 = {
  key: 0,
  class: "bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-lg p-4"
};
const _hoisted_14 = { class: "text-sm font-medium text-green-800 dark:text-green-400 mb-3" };
...
const _hoisted_19 = { class: "text-sm font-medium text-blue-800 dark:text-blue-400 mb-3" };
const _hoisted_20 = { class: "mb-4" };
const _hoisted_21 = { class: "block text-xs font-medium text-gray-700 dark:text-gray-300 mb-2" };
const _hoisted_22 = ["value"];
const _hoisted_23 = { value: "local" };
const _hoisted_24 = { value: "google-drive" };
const _hoisted_25 = { class: "space-y-2" };
const _hoisted_26 = { class: "bg-purple-50 dark:bg-purple-900/10 border border-purple-200 dark:border-purple-800 rounded-lg p-4" };
const _hoisted_27 = { class: "text-sm font-medium text-purple-800 dark:text-purple-400 mb-3" };
const _hoisted_28 = { class: "relative" };
const _hoisted_29 = { class: "space-y-4" };
const _hoisted_30 = { class: "bg-gray-50 dark:bg-[#0f0f0f] border border-gray-200 dark:border-[#0f0f0f] rounded-lg p-4" };
const _hoisted_31 = { class: "text-sm font-medium text-gray-800 dark:text-gray-200 mb-3" };
const _hoisted_32 = { class: "space-y-3" };
const _hoisted_33 = { class: "flex items-center space-x-2" };
const _hoisted_34 = { class: "text-sm text-gray-600 dark:text-gray-400" };
const _hoisted_35 = { class: "flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400" };
const _hoisted_36 = { class: "truncate" };
const _hoisted_37 = {
  key: 0,
  class: "bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4"
};
const _hoisted_38 = { class: "text-sm font-medium text-indigo-800 dark:text-indigo-400 mb-3" };
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _cache[7] || (_cache[7] = createBaseVNode("div", { class: "p-2 bg-blue-100 dark:bg-blue-900/20 rounded-lg" }, [
                createBaseVNode("svg", {
              ...
              createBaseVNode("div", null, [
                createBaseVNode("h3", _hoisted_5, toDisplayString(unref(t)("vocabulary.save.title", "Save & Sync")), 1),
                createBaseVNode("p", _hoisted_6, toDisplayString(unref(t)("vocabulary.save.subtitle", "Manage your vocabulary data storage")), 1)
              ])
            ]),
            createBaseVNode("div", _hoisted_7, [
              createBaseVNode("span", _hoisted_8, toDisplayString(unref(t)("vocabulary.save.mode", "Save Mode")), 1),
        ...
        createBaseVNode("div", _hoisted_10, [
          createBaseVNode("div", _hoisted_11, [
            createBaseVNode("div", _hoisted_12, [
              !_ctx.autoSaveEnabled ? (openBlock(), createElementBlock("div", _hoisted_13, [
                createBaseVNode("h4", _hoisted_14, toDisplayString(unref(t)("vocabulary.save.manualMode", "Manual Save Mode")), 1),
                createBaseVNode("button", {
                  ...
                  _ctx.isSaving ? (openBlock(), createElementBlock("svg", _hoisted_16, _cache[8] || (_cache[8] = [
                  ...
                  ]))) : (openBlock(), createElementBlock("svg", _hoisted_17, _cache[9] || (_cache[9] = [
                    createBaseVNode("path", {
                      "stroke-linecap": "round",
                      "stroke-linejoin": "round",
                      "stroke-width": "2",
              ...
              _ctx.autoSaveEnabled ? (openBlock(), createElementBlock("div", _hoisted_18, [
                createBaseVNode("h4", _hoisted_19, toDisplayString(unref(t)("vocabulary.save.autoMode", "Auto Save Configuration")), 1),
                createBaseVNode("div", _hoisted_20, [
                  createBaseVNode("label", _hoisted_21, toDisplayString(unref(t)("vocabulary.save.storageType", "Storage Type")), 1),
                  createBaseVNode("select", {
                    ...
                    createBaseVNode("option", _hoisted_23, toDisplayString(unref(t)("vocabulary.save.localStorage", "Local File")), 1),
                    createBaseVNode("option", _hoisted_24, toDisplayString(unref(t)("vocabulary.save.googleDrive", "Google Drive")), 1)
                  ], 40, _hoisted_22)
                ]),
                createBaseVNode("div", _hoisted_25, [
                  ...
                  _ctx.storageType === "google-drive" && !_ctx.isGoogleSignedIn ? (openBlock(), createElementBlock("button", {
                    key: 1,
                    onClick: _cache[3] || (_cache[3] = ($event) => emit("google-sign-in")),
                  ...
                  _ctx.storageType === "google-drive" && _ctx.isGoogleSignedIn && !_ctx.hasGoogleDriveFile ? (openBlock(), createElementBlock("button", {
                    key: 2,
                    onClick: _cache[4] || (_cache[4] = ($event) => emit("setup-google-drive")),
                  ...
                  _ctx.storageType === "google-drive" && _ctx.isGoogleSignedIn && _ctx.hasGoogleDriveFile ? (openBlock(), createElementBlock("button", {
                    key: 3,
                    onClick: _cache[5] || (_cache[5] = ($event) => emit("sync-from-google-drive")),
                  ...
                  _ctx.storageType === "local" && _ctx.hasAutoSaveFile || _ctx.storageType === "google-drive" && _ctx.isGoogleSignedIn ? (openBlock(), createElementBlock("button", {
                    key: 4,
                    onClick: _cache[6] || (_cache[6] = ($event) => _ctx.storageType === "local" ? emit("reset-auto-save") : emit("google-sign-out")),
              ...
              createBaseVNode("div", _hoisted_26, [
                createBaseVNode("h4", _hoisted_27, toDisplayString(unref(t)("vocabulary.save.importExport", "Import & Export")), 1),
                createBaseVNode("div", _hoisted_28, [
                  ...
                  createBaseVNode("button", {
                    ...
                    createBaseVNode("span", null, toDisplayString(unref(t)("vocabulary.save.importFile", "Import File")), 1)
                  ])
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_29, [
              createBaseVNode("div", _hoisted_30, [
                createBaseVNode("h4", _hoisted_31, toDisplayString(unref(t)("vocabulary.save.status", "Save Status")), 1),
                createBaseVNode("div", _hoisted_32, [
                  createBaseVNode("div", _hoisted_33, [
                    createBaseVNode("div", {
                      class: normalizeClass(["h-3 w-3 rounded-full", _ctx.saveStatusColor])
                    }, null, 2),
                    createBaseVNode("span", _hoisted_34, toDisplayString(_ctx.saveStatusText), 1)
                  ]),
                  createBaseVNode("div", _hoisted_35, [
                    ...
                    createBaseVNode("span", _hoisted_36, toDisplayString(formattedLastSave.value), 1)
                  ])
                ])
              ]),
              _ctx.autoSaveEnabled ? (openBlock(), createElementBlock("div", _hoisted_37, [
                createBaseVNode("h4", _hoisted_38, toDisplayString(unref(t)("vocabulary.save.storageInfo", "Storage Information")), 1),
                createBaseVNode("div", _hoisted_39, [
                  createBaseVNode("p", _hoisted_40, [
                    createBaseVNode("span", _hoisted_41, toDisplayString(unref(t)("vocabulary.save.type", "Type")) + ":", 1),
                  ...
                  _ctx.storageType === "local" && _ctx.hasAutoSaveFile ? (openBlock(), createElementBlock("p", _hoisted_42, " ✓ " + toDisplayString(unref(t)("vocabulary.save.fileConfigured", "Auto-save file configured")), 1)) : createCommentVNode("", true),
                  _ctx.storageType === "google-drive" && _ctx.isGoogleSignedIn ? (openBlock(), createElementBlock("p", _hoisted_43, " ✓ " + toDisplayString(unref(t)("vocabulary.save.googleConnected", "Google Drive connected")), 1)) : createCommentVNode("", true)
                ])
              ])) : createCommentVNode("", true)
            ])
          ])
...
//# sourceMappingURL=SaveControlPanel-CPfDdqcW.js.map
