...
const _hoisted_6$1 = ["cx", "cy", "r", "stroke", "stroke-width", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap"];
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    progressColor: { default: "#8b5cf6" },
    progressColorSecondary: { default: "#a855f7" },
    progressColorTertiary: { default: "#c084fc" },
    backgroundColor: { default: "#e5e7eb" },
    label: {},
    unit: {},
    showIcon: { type: Boolean, default: false },
    iconClass: { default: "" },
    valueClass: { default: "text-2xl" },
    glowEffect: { type: Boolean, default: true },
    showShimmer: { type: Boolean, default: true },
    strokeLinecap: { default: "round" },
    animationDelay: { default: 0 }
  },
  setup(__props) {
    useCssVars((_ctx) => ({
      "287ce7c8": _ctx.animationDelay + "ms"
    }));
    const props = __props;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        style: normalizeStyle([{ "display": "inline-block", "background": "transparent !important" }, { width: _ctx.size + "px", height: _ctx.size + "px" }])
      }, [
        createBaseVNode("div", {
        ...
        (openBlock(), createElementBlock("svg", {
          ...
          createBaseVNode("defs", null, [
            createBaseVNode("linearGradient", {
              ...
              createBaseVNode("stop", {
                offset: "100%",
                style: normalizeStyle({ stopColor: _ctx.progressColorTertiary, stopOpacity: 1 })
              }, null, 4)
            ], 8, _hoisted_2$1),
            createBaseVNode("linearGradient", {
          ...
          createBaseVNode("circle", {
            ...
            style: normalizeStyle({
              filter: _ctx.glowEffect ? `url(#glow-${gradientId.value}) drop-shadow(0 0 15px ${_ctx.progressColor}40)` : "none",
...
const CircularProgress = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7dfe5f78"]]);
...
const _hoisted_10 = {
  class: "grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6",
  style: { "background": "transparent !important" }
};
const _hoisted_11 = { style: { "background": "transparent !important" } };
const _hoisted_12 = { style: { "background": "transparent !important" } };
const _hoisted_13 = { style: { "background": "transparent !important" } };
const _hoisted_14 = { style: { "background": "transparent !important" } };
...
const FlashcardStats = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-77481a62"]]);
export {
  FlashcardStats as default
};
//# sourceMappingURL=FlashcardStats-azX6w_C7.js.map
