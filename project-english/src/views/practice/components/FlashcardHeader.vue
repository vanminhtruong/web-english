      ...
      <div class="sm:hidden">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-2">
            ...
            <!-- Settings Button -->
            <button @click="$emit('show-settings')" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300" :title="t('flashcard.header.settings', 'Settings')">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div class="flex items-center space-x-2">
            ...
            >
              <option value="flashcard">{{ t('flashcard.modes.flashcard', 'Flashcard') }}</option>
              <option value="quiz">{{ t('flashcard.modes.quiz', 'Quiz') }}</option>
              <option value="typing">{{ t('flashcard.modes.typing', 'Typing') }}</option>
              <option value="listening">{{ t('flashcard.modes.listening', 'Listening') }}</option>
              <option value="image">{{ t('flashcard.modes.image', 'Image') }}</option>
              <option value="pronunciation">{{ t('flashcard.modes.pronunciation', 'Pronunciation') }}</option>
            </select>
