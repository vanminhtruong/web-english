<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
    ...
    <div class="group relative bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-2xl rounded-2xl border border-white/30 dark:border-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-3 animate-fade-in-up"
         style="animation-delay: 0.1s">
      <div class="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-blue-600/20 dark:from-blue-400/20 dark:to-blue-500/30"></div>
      <div class="relative p-6">
        <div class="flex items-center justify-between mb-4">
          <div class="flex-shrink-0">
            <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
    ...
    <div class="group relative bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-2xl rounded-2xl border border-white/30 dark:border-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-3 animate-fade-in-up"
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-green-500/10 to-green-600/20 dark:from-green-400/20 dark:to-green-500/30"></div>
      <div class="relative p-6">
        <div class="flex items-center justify-between mb-4">
          <div class="flex-shrink-0">
            <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="absolute top-4 right-4 w-2 h-2 bg-green-400 rounded-full animate-ping"></div>
    </div>

    <!-- Current Streak Card -->
    <div class="group relative bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-2xl rounded-2xl border border-white/30 dark:border-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-3 animate-fade-in-up"
         style="animation-delay: 0.3s">
      <div class="absolute inset-0 bg-gradient-to-br from-yellow-500/10 to-orange-600/20 dark:from-yellow-400/20 dark:to-orange-500/30"></div>
      <div class="relative p-6">
        <div class="flex items-center justify-between mb-4">
          <div class="flex-shrink-0">
            <div class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="group relative bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-2xl rounded-2xl border border-white/30 dark:border-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-3 animate-fade-in-up"
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-purple-600/20 dark:from-purple-400/20 dark:to-purple-500/30"></div>
      <div class="relative p-6">
        <div class="flex items-center justify-between mb-4">
          <div class="flex-shrink-0">
            <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 2C5.03 2 1 6.03 1 11s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm.5-13H9v6l5.25 3.15.75-1.23-4.5-2.67z"/>
              </svg>
            </div>
          </div>
          <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <div class="absolute top-4 right-4 w-2 h-2 bg-purple-400 rounded-full animate-ping"></div>
    </div>
  </div>
</template>
