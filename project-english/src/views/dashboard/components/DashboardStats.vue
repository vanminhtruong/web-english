  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
      ...
      <div class="p-4 sm:p-5">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div class="w-7 h-7 sm:w-8 sm:h-8 bg-blue-500 dark:bg-blue-600 rounded-md flex items-center justify-center">
    ...
    <div class="bg-white dark:bg-[#0a0a0a] overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-800">
      <div class="p-4 sm:p-5">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div class="w-7 h-7 sm:w-8 sm:h-8 bg-green-500 dark:bg-green-600 rounded-md flex items-center justify-center">
              <svg class="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="bg-white dark:bg-[#0a0a0a] overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-800">
      <div class="p-4 sm:p-5">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div class="w-7 h-7 sm:w-8 sm:h-8 bg-yellow-500 dark:bg-yellow-600 rounded-md flex items-center justify-center">
              <svg class="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="bg-white dark:bg-[#0a0a0a] overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-800">
      <div class="p-4 sm:p-5">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div class="w-7 h-7 sm:w-8 sm:h-8 bg-purple-500 dark:bg-purple-600 rounded-md flex items-center justify-center">
              <svg class="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
