<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-[#0a0a0a] dark:to-[#0f0f0f] relative">
    <!-- Animated Background Elements -->
    <div class="absolute inset-0 overflow-visible pointer-events-none z-0">
    ...
    <!-- Main Content -->
    <div class="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8 relative">
      <!-- Stats Overview -->
          ...
          <div class="group bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md shadow-xl hover:shadow-2xl rounded-2xl border border-white/20 dark:border-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-2 h-full min-h-[420px] flex flex-col">
            <div class="px-6 py-8 sm:p-8 flex-1 flex flex-col">
              <div class="flex items-center mb-6">
                ...
                <h3 class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
              ...
              <div class="grid grid-cols-2 gap-4 flex-1">
                ...
                <button @click="navigateTo('/vocabulary/add')" 
                        class="group/btn relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95">
                  ...
                  <div class="relative z-10 text-center">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 mx-auto mb-2 transform group-hover/btn:rotate-180 transition-transform duration-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd"/>
                    </svg>
                    <span class="text-sm font-medium">{{ t('dashboard.actions.addVocabulary', 'Add Vocabulary') }}</span>
                  </div>
                ...
                <button @click="navigateTo('/practice/flashcard')" 
                        class="group/btn relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95">
                  ...
                  <div class="relative z-10 text-center">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 mx-auto mb-2 transform group-hover/btn:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"/>
                    </svg>
                    <span class="text-sm font-medium">{{ t('dashboard.actions.practiceFlashcard', 'Practice Flashcard') }}</span>
                  </div>
                  <div class="absolute inset-0 bg-white opacity-0 group-hover/btn:opacity-20 transition-opacity duration-300"></div>
                </button>
                ...
                <button @click="navigateTo('/practice/quiz')" 
                        class="group/btn relative overflow-hidden bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95">
                  ...
                  <div class="relative z-10 text-center">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 mx-auto mb-2 transform group-hover/btn:bounce" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/>
                    </svg>
                    <span class="text-sm font-medium">{{ t('dashboard.actions.takeQuiz', 'Take a Quiz') }}</span>
                  </div>
                  <div class="absolute inset-0 bg-white opacity-0 group-hover/btn:opacity-20 transition-opacity duration-300"></div>
                </button>
                ...
                <button @click="navigateTo('/grammar')" 
                        class="group/btn relative overflow-hidden bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95">
                  ...
                  <div class="relative z-10 text-center">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 mx-auto mb-2 transform group-hover/btn:rotate-12 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z"/>
                    </svg>
                    <span class="text-sm font-medium">{{ t('dashboard.actions.learnGrammar', 'Learn Grammar') }}</span>
                  </div>
                  <div class="absolute inset-0 bg-white opacity-0 group-hover/btn:opacity-20 transition-opacity duration-300"></div>
                </button>
              </div>
          ...
          <div class="group bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md shadow-xl hover:shadow-2xl rounded-2xl border border-white/20 dark:border-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-2 h-full min-h-[420px] flex flex-col">
            <div class="px-6 py-8 sm:p-8 flex-1 flex flex-col">
              <div class="flex items-center mb-6">
                ...
                <h3 class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-green-600 to-blue-600 dark:from-green-400 dark:to-blue-400 bg-clip-text text-transparent">
              ...
              <div class="space-y-4 flex-1">
                <div v-for="(activity, index) in recentActivities" 
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">{{ activity.title }}</p>
                    <p class="text-xs text-blue-600 dark:text-blue-400 font-medium">{{ activity.time }}</p>
                  </div>
