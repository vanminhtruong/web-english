    ...
    <div class="bg-white dark:bg-[#0a0a0a] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
      <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
          {{ t('grammar.practice.exerciseManager.title') }}
        </h3>
        <button
          @click="closeModal"
      ...
      <div class="space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <h4 class="text-md font-medium text-gray-900 dark:text-white mb-4">
            {{ t('grammar.practice.exerciseManager.addNew') }}
          </h4>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {{ t('grammar.practice.exerciseManager.exerciseType') }}
              </label>
              <input
                ...
                :placeholder="t('grammar.practice.exerciseManager.typePlaceholder')"
              >
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              ...
              <input
                ...
                type="text"
                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                :placeholder="t('grammar.practice.exerciseManager.titlePlaceholder')"
              >
            </div>
            <div class="md:col-span-2">
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {{ t('grammar.practice.exerciseManager.description') }}
              </label>
              <textarea
                v-model="newExercise.description"
                rows="3"
                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                :placeholder="t('grammar.practice.exerciseManager.descriptionPlaceholder')"
              ></textarea>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {{ t('grammar.practice.exerciseManager.difficulty') }}
              </label>
              <select
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {{ t('grammar.practice.exerciseManager.duration') }}
              </label>
              <input
                v-model="newExercise.duration"
                type="text"
                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                :placeholder="t('grammar.practice.exerciseManager.durationPlaceholder')"
              >
            </div>
          </div>
          <div class="flex justify-end mt-4">
            ...
            >
              {{ t('grammar.practice.exerciseManager.add') }}
            </button>
          </div>
        </div>
        ...
        <div>
          <h4 class="text-md font-medium text-gray-900 dark:text-white mb-4">
            {{ t('grammar.practice.exerciseManager.existing') }}
          </h4>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              ...
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  <div class="flex items-center space-x-2 mb-2">
                    ...
                    <h5 class="font-medium text-gray-900 dark:text-white">{{ t(`grammar.practice.exercises.${exercise.type}.title`) }}</h5>
                  </div>
                  <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ t(`grammar.practice.exercises.${exercise.type}.description`) }}</p>
                ...
                <div class="flex items-center space-x-2 ml-4">
                  <button
                    ...
                    :title="t('grammar.practice.exerciseManager.manageQuestions')"
                  >
