<template>
  <div class="bg-white dark:bg-[#0a0a0a] shadow rounded-lg p-6 mb-6 border border-gray-200 dark:border-gray-700">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div class="md:col-span-2">
        ...
        <input
          ...
          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
    ...
    <div class="mt-4">
      <label class="inline-flex items-center">
        ...
        >
        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ t('vocabulary.showFavoritesOnly') }}</span>
      </label>
    </div>
  </div>
</template>
