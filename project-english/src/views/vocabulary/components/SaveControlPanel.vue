  ...
  <div class="bg-white dark:bg-[#0a0a0a] rounded-lg shadow border border-gray-200 dark:border-gray-700 p-3 sm:p-4 md:p-5 lg:p-6 mb-4 sm:mb-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
      <div class="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
        ...
        <div class="flex flex-wrap items-center gap-2 sm:space-x-2">
          ...
          <button
            ...
            :disabled="isSaving"
            class="px-3 py-1.5 sm:px-4 sm:py-2 bg-green-500 hover:bg-green-600 disabled:bg-gray-400 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors flex items-center space-x-1 sm:space-x-2"
          >
          ...
          <button
            ...
            class="px-3 py-1.5 sm:px-4 sm:py-2 bg-orange-500 hover:bg-orange-600 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors flex items-center space-x-1 sm:space-x-2"
          >
          ...
          <button
            ...
            class="px-3 py-1.5 sm:px-4 sm:py-2 bg-gray-500 hover:bg-gray-600 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors flex items-center space-x-1 sm:space-x-2"
          >
      ...
      <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div v-if="autoSaveEnabled && hasAutoSaveFile && autoSaveFilePath" class="flex items-center space-x-1">
          <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
          <span>{{ autoSaveFilePath }}</span>
        </div>
      </div>
    </div>
  </div>
