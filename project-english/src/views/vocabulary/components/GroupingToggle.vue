  ...
  <div class="bg-white dark:bg-[#0a0a0a] rounded-lg shadow border border-gray-200 dark:border-gray-700 p-3 sm:p-4 md:p-5 lg:p-6 mb-4 sm:mb-6">
    ...
    <div class="flex items-center justify-between mb-3 sm:mb-4">
      <div class="flex items-center space-x-2 sm:space-x-3">
        ...
        <div>
          <h3 class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{ t('vocabulary.grouping.title') }}</h3>
          <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">{{ t('vocabulary.grouping.description') }}</p>
        </div>
      </div>
      <button
    ...
    <div v-if="modelValue" class="flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-700">
      <div class="flex items-center space-x-2 sm:space-x-3">
        ...
        <div>
          <h3 class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{ t('vocabulary.grouping.hoverToExpand') }}</h3>
          <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">{{ t('vocabulary.grouping.hoverDescription') }}</p>
        </div>
      </div>
      <button
